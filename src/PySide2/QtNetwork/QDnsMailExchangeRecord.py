...
class QDnsMailExchangeRecord(__Shiboken.Object):
    """
    QDnsMailExchangeRecord(self) -> None
    QDnsMailExchangeRecord(self, other: PySide2.QtNetwork.QDnsMailExchangeRecord) -> None
    """
    ...
    def swap(self, other): # real signature unknown; restored from __doc__
        """ swap(self, other: PySide2.QtNetwork.QDnsMailExchangeRecord) -> None """
        pass
