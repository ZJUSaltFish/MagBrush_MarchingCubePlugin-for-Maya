...
class QListWidgetItem(__Shiboken.Object):
    """
    QListWidgetItem(self, icon: PySide2.QtGui.QIcon, text: str, listview: typing.Optional[PySide2.QtWidgets.QListWidget] = None, type: int = PySide2.QtWidgets.QListWidgetItem.ItemType.Type) -> None
    QListWidgetItem(self, listview: typing.Optional[PySide2.QtWidgets.QListWidget] = None, type: int = PySide2.QtWidgets.QListWidgetItem.ItemType.Type) -> None
    QListWidgetItem(self, other: PySide2.QtWidgets.QListWidgetItem) -> None
    QListWidgetItem(self, text: str, listview: typing.Optional[PySide2.QtWidgets.QListWidget] = None, type: int = PySide2.QtWidgets.QListWidgetItem.ItemType.Type) -> None
    """
    ...
    def clone(self): # real signature unknown; restored from __doc__
        """ clone(self) -> PySide2.QtWidgets.QListWidgetItem """
        pass
    ...
    def listWidget(self): # real signature unknown; restored from __doc__
        """ listWidget(self) -> PySide2.QtWidgets.QListWidget """
        pass
    ...
    def __init__(self, icon, text, listview, PySide2_QtWidgets_QListWidget=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        pass
    ...
    ItemType = None # (!) real value is "<class 'PySide2.QtWidgets.QListWidgetItem.ItemType'>"
    Type = PySide2.QtWidgets.QListWidgetItem.ItemType.Type
    UserType = PySide2.QtWidgets.QListWidgetItem.ItemType.UserType
    __hash__ = None
