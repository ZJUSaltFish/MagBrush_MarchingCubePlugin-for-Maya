...
class QPlaceManagerEngine(__PySide2_QtCore.QObject):
    """ QPlaceManagerEngine(self, parameters: typing.Dict[str, typing.Any], parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None """
    ...
    def childCategoryIds(self, categoryId): # real signature unknown; restored from __doc__
        """ childCategoryIds(self, categoryId: str) -> typing.List[str] """
        pass

    def compatiblePlace(self, original): # real signature unknown; restored from __doc__
        """ compatiblePlace(self, original: PySide2.QtLocation.QPlace) -> PySide2.QtLocation.QPlace """
        pass

    def constructIconUrl(self, icon, size): # real signature unknown; restored from __doc__
        """ constructIconUrl(self, icon: PySide2.QtLocation.QPlaceIcon, size: PySide2.QtCore.QSize) -> PySide2.QtCore.QUrl """
        pass
    ...
    def manager(self): # real signature unknown; restored from __doc__
        """ manager(self) -> PySide2.QtLocation.QPlaceManager """
        pass
    ...
    def search(self, request): # real signature unknown; restored from __doc__
        """ search(self, request: PySide2.QtLocation.QPlaceSearchRequest) -> PySide2.QtLocation.QPlaceSearchReply """
        pass
    ...
    def setLocales(self, locales, PySide2_QtCore_QLocale=None): # real signature unknown; restored from __doc__
        """ setLocales(self, locales: typing.Sequence[PySide2.QtCore.QLocale]) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x0000013BA752F740>'
