...
class QAmbientTemperatureReading(QSensorReading):
    """ QAmbientTemperatureReading(self, parent: PySide2.QtCore.QObject) -> None """
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x00000206286B2680>'
