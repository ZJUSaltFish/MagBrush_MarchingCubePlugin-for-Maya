...
class QIRProximityReading(QSensorReading):
    """ QIRProximityReading(self, parent: PySide2.QtCore.QObject) -> None """
    ...
    def setReflectance(self, reflectance): # real signature unknown; restored from __doc__
        """ setReflectance(self, reflectance: float) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x00000206286B17C0>'
