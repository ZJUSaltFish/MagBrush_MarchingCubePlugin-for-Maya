...
class QRotationReading(QSensorReading):
    """ QRotationReading(self, parent: PySide2.QtCore.QObject) -> None """
    ...
    def setFromEuler(self, x, y, z): # real signature unknown; restored from __doc__
        """ setFromEuler(self, x: float, y: float, z: float) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x00000206286B25C0>'
