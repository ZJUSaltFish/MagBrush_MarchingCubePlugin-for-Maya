...
class QMagnetometerReading(QSensorReading):
    """ QMagnetometerReading(self, parent: PySide2.QtCore.QObject) -> None """
    ...
    def setCalibrationLevel(self, calibrationLevel): # real signature unknown; restored from __doc__
        """ setCalibrationLevel(self, calibrationLevel: float) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x00000206286B0FC0>'
