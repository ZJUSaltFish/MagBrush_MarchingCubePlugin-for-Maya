...
class QHumidityReading(QSensorReading):
    """ QHumidityReading(self, parent: PySide2.QtCore.QObject) -> None """
    ...
    def setAbsoluteHumidity(self, value): # real signature unknown; restored from __doc__
        """ setAbsoluteHumidity(self, value: float) -> None """
        pass

    def setRelativeHumidity(self, percent): # real signature unknown; restored from __doc__
        """ setRelativeHumidity(self, percent: float) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x00000206286B1EC0>'
