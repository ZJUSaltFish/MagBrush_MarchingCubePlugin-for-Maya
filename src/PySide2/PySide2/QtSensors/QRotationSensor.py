...
class QRotationSensor(QSensor):
    """ QRotationSensor(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None """
    ...
    def reading(self): # real signature unknown; restored from __doc__
        """ reading(self) -> PySide2.QtSensors.QRotationReading """
        pass

    def setHasZ(self, hasZ): # real signature unknown; restored from __doc__
        """ setHasZ(self, hasZ: bool) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x00000206286C6BC0>'
