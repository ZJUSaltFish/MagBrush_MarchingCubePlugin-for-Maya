...
class QHolsterReading(QSensorReading):
    """ QHolsterReading(self, parent: PySide2.QtCore.QObject) -> None """
    ...
    def setHolstered(self, holstered): # real signature unknown; restored from __doc__
        """ setHolstered(self, holstered: bool) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x00000206286B20C0>'
