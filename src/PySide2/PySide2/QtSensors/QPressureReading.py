...
class QPressureReading(QSensorReading):
    """ QPressureReading(self, parent: PySide2.QtCore.QObject) -> None """
    ...
    def setPressure(self, pressure): # real signature unknown; restored from __doc__
        """ setPressure(self, pressure: float) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x00000206286B0900>'
