...
class QCustomAudioRoleControl(QMediaControl):
    """ QCustomAudioRoleControl(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None """
    ...
    def setCustomAudioRole(self, role): # real signature unknown; restored from __doc__
        """ setCustomAudioRole(self, role: str) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x000001887467AF40>'
