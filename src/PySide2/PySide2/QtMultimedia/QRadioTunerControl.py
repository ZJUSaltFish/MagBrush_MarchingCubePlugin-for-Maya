...
class QRadioTunerControl(QMediaControl):
    """ QRadioTunerControl(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None """
    ...
    def frequencyRange(self, b): # real signature unknown; restored from __doc__
        """ frequencyRange(self, b: PySide2.QtMultimedia.QRadioTuner.Band) -> typing.Tuple[int, int] """
        pass

    def frequencyStep(self, b): # real signature unknown; restored from __doc__
        """ frequencyStep(self, b: PySide2.QtMultimedia.QRadioTuner.Band) -> int """
        return 0
    ...
    def setBand(self, b): # real signature unknown; restored from __doc__
        """ setBand(self, b: PySide2.QtMultimedia.QRadioTuner.Band) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x0000018874679F00>'
