...
class QCameraViewfinderSettingsControl2(QMediaControl):
    """ QCameraViewfinderSettingsControl2(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None """
    ...
    def supportedViewfinderSettings(self): # real signature unknown; restored from __doc__
        """ supportedViewfinderSettings(self) -> typing.List[PySide2.QtMultimedia.QCameraViewfinderSettings] """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x000001887467B100>'
