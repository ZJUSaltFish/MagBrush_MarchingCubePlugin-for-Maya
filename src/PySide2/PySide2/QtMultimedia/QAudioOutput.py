...
class QAudioOutput(__PySide2_QtCore.QObject):
    """
    QAudioOutput(self, audioDeviceInfo: PySide2.QtMultimedia.QAudioDeviceInfo, format: PySide2.QtMultimedia.QAudioFormat = Default(QAudioFormat), parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None
    QAudioOutput(self, format: PySide2.QtMultimedia.QAudioFormat = Default(QAudioFormat), parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None
    """
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x00000188746B8440>'
