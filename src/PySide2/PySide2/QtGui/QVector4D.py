...
class QVector4D(__Shiboken.Object):
    """
    QVector4D(self) -> None
    QVector4D(self, point: PySide2.QtCore.QPoint) -> None
    QVector4D(self, point: PySide2.QtCore.QPointF) -> None
    QVector4D(self, vector: PySide2.QtGui.QVector2D) -> None
    QVector4D(self, vector: PySide2.QtGui.QVector2D, zpos: float, wpos: float) -> None
    QVector4D(self, vector: PySide2.QtGui.QVector3D) -> None
    QVector4D(self, vector: PySide2.QtGui.QVector3D, wpos: float) -> None
    QVector4D(self, xpos: float, ypos: float, zpos: float, wpos: float) -> None
    """
