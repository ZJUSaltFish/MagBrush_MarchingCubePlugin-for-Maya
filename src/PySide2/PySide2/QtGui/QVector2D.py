...
class QVector2D(__Shiboken.Object):
    """
    QVector2D(self) -> None
    QVector2D(self, point: PySide2.QtCore.QPoint) -> None
    QVector2D(self, point: PySide2.QtCore.QPointF) -> None
    QVector2D(self, vector: PySide2.QtGui.QVector3D) -> None
    QVector2D(self, vector: PySide2.QtGui.QVector4D) -> None
    QVector2D(self, xpos: float, ypos: float) -> None
    """
