...
class QGraphicsPathItem(QAbstractGraphicsShapeItem):
    """
    QGraphicsPathItem(self, parent: typing.Optional[PySide2.QtWidgets.QGraphicsItem] = None) -> None
    QGraphicsPathItem(self, path: PySide2.QtGui.QPainterPath, parent: typing.Optional[PySide2.QtWidgets.QGraphicsItem] = None) -> None
    """
    ...
    def path(self): # real signature unknown; restored from __doc__
        """ path(self) -> PySide2.QtGui.QPainterPath """
        pass

    def setPath(self, path): # real signature unknown; restored from __doc__
        """ setPath(self, path: PySide2.QtGui.QPainterPath) -> None """
        pass
