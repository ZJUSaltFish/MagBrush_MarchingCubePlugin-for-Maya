...
class QGraphicsRectItem(QAbstractGraphicsShapeItem):
    """
    QGraphicsRectItem(self, parent: typing.Optional[PySide2.QtWidgets.QGraphicsItem] = None) -> None
    QGraphicsRectItem(self, rect: PySide2.QtCore.QRectF, parent: typing.Optional[PySide2.QtWidgets.QGraphicsItem] = None) -> None
    QGraphicsRectItem(self, x: float, y: float, w: float, h: float, parent: typing.Optional[PySide2.QtWidgets.QGraphicsItem] = None) -> None
    """
