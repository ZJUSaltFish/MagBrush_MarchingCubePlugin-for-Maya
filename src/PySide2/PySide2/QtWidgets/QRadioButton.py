...
class QRadioButton(QAbstractButton):
    """
    QRadioButton(self, parent: typing.Optional[PySide2.QtWidgets.QWidget] = None) -> None
    QRadioButton(self, text: str, parent: typing.Optional[PySide2.QtWidgets.QWidget] = None) -> None
    """
    def event(self, e): # real signature unknown; restored from __doc__
        """ event(self, e: PySide2.QtCore.QEvent) -> bool """
        return False

    def hitButton(self, arg__1): # real signature unknown; restored from __doc__
        """ hitButton(self, arg__1: PySide2.QtCore.QPoint) -> bool """
        return False

    def initStyleOption(self, button): # real signature unknown; restored from __doc__
        """ initStyleOption(self, button: PySide2.QtWidgets.QStyleOptionButton) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x0000014F50817A00>'
