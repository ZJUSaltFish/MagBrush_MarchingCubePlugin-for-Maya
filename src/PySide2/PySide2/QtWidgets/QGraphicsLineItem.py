...
class QGraphicsLineItem(QGraphicsItem):
    """
    QGraphicsLineItem(self, line: PySide2.QtCore.QLineF, parent: typing.Optional[PySide2.QtWidgets.QGraphicsItem] = None) -> None
    QGraphicsLineItem(self, parent: typing.Optional[PySide2.QtWidgets.QGraphicsItem] = None) -> None
    QGraphicsLineItem(self, x1: float, y1: float, x2: float, y2: float, parent: typing.Optional[PySide2.QtWidgets.QGraphicsItem] = None) -> None
    """
    ...
    def line(self): # real signature unknown; restored from __doc__
        """ line(self) -> PySide2.QtCore.QLineF """
        pass
    ...
    def setLine(self, line): # real signature unknown; restored from __doc__
        """
        setLine(self, line: PySide2.QtCore.QLineF) -> None
    ...
    def __init__(self, line, parent, PySide2_QtWidgets_QGraphicsItem=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        pass
