...
class QAccessibleTextRemoveEvent(QAccessibleTextCursorEvent):
    """
    QAccessibleTextRemoveEvent(self, iface: PySide2.QtGui.QAccessibleInterface, position: int, text: str) -> None
    QAccessibleTextRemoveEvent(self, obj: PySide2.QtCore.QObject, position: int, text: str) -> None
    """
