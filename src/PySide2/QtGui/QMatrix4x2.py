...
class QMatrix4x2(__Shiboken.Object):
    """
    QMatrix4x2(self) -> None
    QMatrix4x2(self, QMatrix4x2: PySide2.QtGui.QMatrix4x2) -> None
    QMatrix4x2(self, arg__1: typing.Iterable) -> None
    """
    ...
    def __call__(self, row, column): # real signature unknown; restored from __doc__
        """
