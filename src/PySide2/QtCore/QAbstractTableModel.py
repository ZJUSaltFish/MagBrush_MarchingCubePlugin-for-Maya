...
class QAbstractTableModel(QAbstractItemModel):
    """ QAbstractTableModel(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None """
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x0000022221E4F180>'
