...
class QProximityReading(QSensorReading):
    """ QProximityReading(self, parent: PySide2.QtCore.QObject) -> None """
    ...
    def setClose(self, close): # real signature unknown; restored from __doc__
        """ setClose(self, close: bool) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x00000206286B2780>'
