...
class QLightReading(QSensorReading):
    """ QLightReading(self, parent: PySide2.QtCore.QObject) -> None """
    ...
    def lux(self): # real signature unknown; restored from __doc__
        """ lux(self) -> float """
        return 0.0

    def setLux(self, lux): # real signature unknown; restored from __doc__
        """ setLux(self, lux: float) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x00000206286B11C0>'
