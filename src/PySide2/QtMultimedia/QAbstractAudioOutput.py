...
class QAbstractAudioOutput(__PySide2_QtCore.QObject):
    """ QAbstractAudioOutput(self) -> None """
    ...
    def setCategory(self, arg__1): # real signature unknown; restored from __doc__
        """ setCategory(self, arg__1: str) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x000001887464DAC0>'
