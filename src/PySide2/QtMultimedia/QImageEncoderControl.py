...
class QImageEncoderControl(QMediaControl):
    """ QImageEncoderControl(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None """
    def imageCodecDescription(self, codec): # real signature unknown; restored from __doc__
        """ imageCodecDescription(self, codec: str) -> str """
        return ""

    def imageSettings(self): # real signature unknown; restored from __doc__
        """ imageSettings(self) -> PySide2.QtMultimedia.QImageEncoderSettings """
        pass

    def setImageSettings(self, settings): # real signature unknown; restored from __doc__
        """ setImageSettings(self, settings: PySide2.QtMultimedia.QImageEncoderSettings) -> None """
        pass
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x000001887467AE80>'
