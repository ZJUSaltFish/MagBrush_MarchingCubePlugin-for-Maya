...
class QCameraCaptureBufferFormatControl(QMediaControl):
    """ QCameraCaptureBufferFormatControl(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None """
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x00000188746A55C0>'
