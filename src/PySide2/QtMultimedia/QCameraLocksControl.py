...
class QCameraLocksControl(QMediaControl):
    """ QCameraLocksControl(self, parent: typing.Optional[PySide2.QtCore.QObject] = None) -> None """
    ...
    def searchAndLock(self, locks): # real signature unknown; restored from __doc__
    ...
    def unlock(self, locks): # real signature unknown; restored from __doc__
    ...
    staticMetaObject = None # (!) real value is '<PySide2.QtCore.QMetaObject object at 0x000001887467B4C0>'
