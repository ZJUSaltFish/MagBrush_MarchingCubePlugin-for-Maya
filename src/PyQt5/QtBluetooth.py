...
# from D:\Maya2024\Python\lib\site-packages\PyQt5\QtBluetooth.pyd
# by generator 1.147
# no doc
...
class QBluetoothTransferManager(__PyQt5_QtCore.QObject):
    """ QBluetoothTransferManager(parent: typing.Optional[QObject] = None) """
    def childEvent(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def put(self, request, data): # real signature unknown; restored from __doc__
        """ put(self, request: QBluetoothTransferRequest, data: QIODevice) -> QBluetoothTransferReply """
...
class QBluetoothTransferReply(__PyQt5_QtCore.QObject):
    """ QBluetoothTransferReply(parent: typing.Optional[QObject] = None) """
    def abort(self): # real signature unknown; restored from __doc__
        """ abort(self) """
        pass
    ...
    def setManager(self, manager): # real signature unknown; restored from __doc__
        """ setManager(self, manager: QBluetoothTransferManager) """
        pass
...
class QLowEnergyController(__PyQt5_QtCore.QObject):
    """
    QLowEnergyController(remoteDevice: QBluetoothDeviceInfo, parent: typing.Optional[QObject] = None)
    QLowEnergyController(remoteDevice: QBluetoothAddress, parent: typing.Optional[QObject] = None)
    QLowEnergyController(remoteDevice: QBluetoothAddress, localDevice: QBluetoothAddress, parent: typing.Optional[QObject] = None)
    """
    ...
    def createCentral(self, remoteDevice, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        createCentral(remoteDevice: QBluetoothAddress, localDevice: QBluetoothAddress, parent: typing.Optional[QObject] = None) -> QLowEnergyController
        """
        pass
