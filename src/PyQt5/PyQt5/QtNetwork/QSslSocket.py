...
class QSslSocket(QTcpSocket):
    ...
    def addCaCertificates(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        addCaCertificates(self, path: str, format: QSsl.EncodingFormat = QSsl.Pem, syntax: QRegExp.PatternSyntax = QRegExp.FixedString) -> bool
    ...
    def addDefaultCaCertificates(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        addDefaultCaCertificates(path: str, format: QSsl.EncodingFormat = QSsl.Pem, syntax: QRegExp.PatternSyntax = QRegExp.FixedString) -> bool
    ...
    def connectToHost(self, hostName, port, mode, QIODevice_OpenMode=None, QIODevice_OpenModeFlag=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ connectToHost(self, hostName: str, port: int, mode: Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = QIODevice.ReadWrite, protocol: QAbstractSocket.NetworkLayerProtocol = QAbstractSocket.AnyIPProtocol) """
        pass
    ...
    def connectToHostEncrypted(self, hostName, port, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        connectToHostEncrypted(self, hostName: str, port: int, mode: Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = QIODevice.ReadWrite, protocol: QAbstractSocket.NetworkLayerProtocol = QAbstractSocket.AnyIPProtocol)
        connectToHostEncrypted(self, hostName: str, port: int, sslPeerName: str, mode: Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = QIODevice.ReadWrite, protocol: QAbstractSocket.NetworkLayerProtocol = QAbstractSocket.AnyIPProtocol)
        """
        pass
    ...
    def setCiphers(self, ciphers, QSslCipher=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setCiphers(self, ciphers: Iterable[QSslCipher])
        setCiphers(self, ciphers: str)
        """
        pass
    ...
    def setPrivateKey(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        setPrivateKey(self, fileName: str, algorithm: QSsl.KeyAlgorithm = QSsl.Rsa, format: QSsl.EncodingFormat = QSsl.Pem, passPhrase: Union[QByteArray, bytes, bytearray] = QByteArray())
        """
        pass
