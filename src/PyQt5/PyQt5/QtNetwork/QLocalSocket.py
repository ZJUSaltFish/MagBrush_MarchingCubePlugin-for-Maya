...
class QLocalSocket(__PyQt5_QtCore.QIODevice):
    ...
    def connectToServer(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        connectToServer(self, name: str, mode: Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = QIODevice.ReadWrite)
    ...
    def writeData(self, a0, bytes=None): # real signature unknown; restored from __doc__
        """ writeData(self, a0: PyQt5.sip.array[bytes]) -> int """
        return 0
