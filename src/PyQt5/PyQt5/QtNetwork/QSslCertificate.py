...
class QSslCertificate(__sip.simplewrapper):
    """
    QSslCertificate(device: QIODevice, format: QSsl.EncodingFormat = QSsl.Pem)
    ...
    def fromDevice(self, device, format=None): # real signature unknown; restored from __doc__
        """ fromDevice(device: QIODevice, format: QSsl.EncodingFormat = QSsl.Pem) -> List[QSslCertificate] """
        return []

    def fromPath(self, path, format=None, syntax=None): # real signature unknown; restored from __doc__
        """ fromPath(path: str, format: QSsl.EncodingFormat = QSsl.Pem, syntax: QRegExp.PatternSyntax = QRegExp.FixedString) -> List[QSslCertificate] """
        return []

    def handle(self): # real signature unknown; restored from __doc__
        """ handle(self) -> PyQt5.sip.voidptr """
        pass

    def importPkcs12(self, device, key, certificate, caCertificates, Iterable=None, QSslCertificate=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ importPkcs12(device: QIODevice, key: QSslKey, certificate: QSslCertificate, caCertificates: typing.Optional[Iterable[QSslCertificate]] = [], passPhrase: Union[QByteArray, bytes, bytearray] = QByteArray()) -> bool """
        pass
    ...
    def verify(self, certificateChain, QSslCertificate=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ verify(certificateChain: Iterable[QSslCertificate], hostName: str = '') -> List[QSslError] """
        pass
