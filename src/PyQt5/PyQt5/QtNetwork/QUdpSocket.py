...
class QUdpSocket(QAbstractSocket):
    """ QUdpSocket(parent: typing.Optional[QObject] = None) """
    ...
    def readDatagram(self, maxlen): # real signature unknown; restored from __doc__
        """ readDatagram(self, maxlen: int) -> Tuple[bytes, QHostAddress, int] """
        pass
    ...
    def writeDatagram(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        writeDatagram(self, data: PyQt5.sip.array[bytes], host: Union[QHostAddress, QHostAddress.SpecialAddress], port: int) -> int
