...
class QDnsLookup(__PyQt5_QtCore.QObject):
    """
    QDnsLookup(parent: typing.Optional[QObject] = None)
    QDnsLookup(type: QDnsLookup.Type, name: str, parent: typing.Optional[QObject] = None)
    QDnsLookup(type: QDnsLookup.Type, name: str, nameserver: Union[QHostAddress, QHostAddress.SpecialAddress], parent: typing.Optional[QObject] = None)
    """
