...
class QNetworkSession(__PyQt5_QtCore.QObject):
    """ QNetworkSession(connConfig: QNetworkConfiguration, parent: typing.Optional[QObject] = None) """
