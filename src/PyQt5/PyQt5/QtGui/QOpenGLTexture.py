...
class QOpenGLTexture(__sip.simplewrapper):
    ...
    def createTextureView(self, target, viewFormat, minimumMipmapLevel, maximumMipmapLevel, minimumLayer, maximumLayer): # real signature unknown; restored from __doc__
        """ createTextureView(self, target: QOpenGLTexture.Target, viewFormat: QOpenGLTexture.TextureFormat, minimumMipmapLevel: int, maximumMipmapLevel: int, minimumLayer: int, maximumLayer: int) -> QOpenGLTexture """
    ...
    def setBorderColor(self, color, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setBorderColor(self, color: Union[QColor, Qt.GlobalColor, QGradient]) """
        pass
    ...
    def setCompressedData(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setCompressedData(self, mipLevel: int, layer: int, cubeFace: QOpenGLTexture.CubeMapFace, dataSize: int, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setCompressedData(self, mipLevel: int, layer: int, dataSize: int, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setCompressedData(self, mipLevel: int, dataSize: int, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setCompressedData(self, dataSize: int, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setCompressedData(self, mipLevel: int, layer: int, layerCount: int, cubeFace: QOpenGLTexture.CubeMapFace, dataSize: int, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        """
        pass

    def setData(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setData(self, mipLevel: int, layer: int, cubeFace: QOpenGLTexture.CubeMapFace, sourceFormat: QOpenGLTexture.PixelFormat, sourceType: QOpenGLTexture.PixelType, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setData(self, mipLevel: int, layer: int, sourceFormat: QOpenGLTexture.PixelFormat, sourceType: QOpenGLTexture.PixelType, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setData(self, mipLevel: int, sourceFormat: QOpenGLTexture.PixelFormat, sourceType: QOpenGLTexture.PixelType, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setData(self, sourceFormat: QOpenGLTexture.PixelFormat, sourceType: QOpenGLTexture.PixelType, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setData(self, image: QImage, genMipMaps: QOpenGLTexture.MipMapGeneration = QOpenGLTexture.GenerateMipMaps)
        setData(self, mipLevel: int, layer: int, layerCount: int, cubeFace: QOpenGLTexture.CubeMapFace, sourceFormat: QOpenGLTexture.PixelFormat, sourceType: QOpenGLTexture.PixelType, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setData(self, xOffset: int, yOffset: int, zOffset: int, width: int, height: int, depth: int, sourceFormat: QOpenGLTexture.PixelFormat, sourceType: QOpenGLTexture.PixelType, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setData(self, xOffset: int, yOffset: int, zOffset: int, width: int, height: int, depth: int, mipLevel: int, sourceFormat: QOpenGLTexture.PixelFormat, sourceType: QOpenGLTexture.PixelType, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setData(self, xOffset: int, yOffset: int, zOffset: int, width: int, height: int, depth: int, mipLevel: int, layer: int, sourceFormat: QOpenGLTexture.PixelFormat, sourceType: QOpenGLTexture.PixelType, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setData(self, xOffset: int, yOffset: int, zOffset: int, width: int, height: int, depth: int, mipLevel: int, layer: int, cubeFace: QOpenGLTexture.CubeMapFace, sourceFormat: QOpenGLTexture.PixelFormat, sourceType: QOpenGLTexture.PixelType, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        setData(self, xOffset: int, yOffset: int, zOffset: int, width: int, height: int, depth: int, mipLevel: int, layer: int, cubeFace: QOpenGLTexture.CubeMapFace, layerCount: int, sourceFormat: QOpenGLTexture.PixelFormat, sourceType: QOpenGLTexture.PixelType, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = None)
        """
        pass
