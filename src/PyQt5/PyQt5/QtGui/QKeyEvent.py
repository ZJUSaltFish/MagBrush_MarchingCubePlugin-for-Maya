...
class QKeyEvent(QInputEvent):
    """
    QKeyEvent(type: QEvent.Type, key: int, modifiers: Union[Qt.KeyboardModifiers, Qt.KeyboardModifier], nativeScanCode: int, nativeVirtualKey: int, nativeModifiers: int, text: str = '', autorep: bool = False, count: int = 1)
    QKeyEvent(type: QEvent.Type, key: int, modifiers: Union[Qt.KeyboardModifiers, Qt.KeyboardModifier], text: str = '', autorep: bool = False, count: int = 1)
