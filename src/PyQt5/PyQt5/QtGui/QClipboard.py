...
class QClipboard(__PyQt5_QtCore.QObject):
    ...
    def setText(self, a0, mode=None): # real signature unknown; restored from __doc__
        """ setText(self, a0: str, mode: QClipboard.Mode = QClipboard.Clipboard) """
        pass
    ...
    def text(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        text(self, subtype: str, mode: QClipboard.Mode = QClipboard.Clipboard) -> Tuple[str, str]
        """
        return ""
