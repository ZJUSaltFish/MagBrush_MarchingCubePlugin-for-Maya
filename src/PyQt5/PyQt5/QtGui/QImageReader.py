...
class QImageReader(__sip.simplewrapper):
    """
    QImageReader()
    QImageReader(device: QIODevice, format: Union[QByteArray, bytes, bytearray] = QByteArray())
    QImageReader(fileName: str, format: Union[QByteArray, bytes, bytearray] = QByteArray())
    """
    ...
    def imageFormat(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        imageFormat(fileName: str) -> QByteArray
    ...
    def read(self, image=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        read(self) -> QImage
    ...
    def setBackgroundColor(self, color, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
