...
class QOpenGLShader(__PyQt5_QtCore.QObject):
    """ QOpenGLShader(type: Union[QOpenGLShader.ShaderType, QOpenGLShader.ShaderTypeBit], parent: typing.Optional[QObject] = None) """
    def childEvent(self, *args, **kwargs): # real signature unknown
        pass

    def compileSourceCode(self, source, QByteArray=None, bytes=None, bytearray=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def hasOpenGLShaders(self, type, QOpenGLShader_ShaderType=None, QOpenGLShader_ShaderTypeBit=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ hasOpenGLShaders(type: Union[QOpenGLShader.ShaderType, QOpenGLShader.ShaderTypeBit], context: typing.Optional[QOpenGLContext] = None) -> bool """
        pass
