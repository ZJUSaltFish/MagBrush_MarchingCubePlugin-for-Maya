...
class QImage(QPaintDevice):
    ...
    QImage(data: bytes, width: int, height: int, format: QImage.Format)
    QImage(data: PyQt5.sip.voidptr, width: int, height: int, format: QImage.Format)
    QImage(data: bytes, width: int, height: int, bytesPerLine: int, format: QImage.Format)
    QImage(data: PyQt5.sip.voidptr, width: int, height: int, bytesPerLine: int, format: QImage.Format)
    QImage(xpm: List[str])
    QImage(fileName: str, format: typing.Optional[str] = None)
    QImage(a0: QImage)
    QImage(variant: Any)
    """
    ...
    def constBits(self): # real signature unknown; restored from __doc__
        """ constBits(self) -> PyQt5.sip.voidptr """
        pass

    def constScanLine(self, a0): # real signature unknown; restored from __doc__
        """ constScanLine(self, a0: int) -> PyQt5.sip.voidptr """
        pass
    ...
    def fill(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        fill(self, color: Union[QColor, Qt.GlobalColor, QGradient])
        fill(self, pixel: int)
        """
        pass
    ...
    def fromData(self, data, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        fromData(data: PyQt5.sip.array[bytes], format: typing.Optional[str] = None) -> QImage
        fromData(data: Union[QByteArray, bytes, bytearray], format: typing.Optional[str] = None) -> QImage
        """
        pass
    ...
    def load(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        load(self, device: QIODevice, format: str) -> bool
        load(self, fileName: str, format: typing.Optional[str] = None) -> bool
        """
        return False

    def loadFromData(self, data, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        loadFromData(self, data: PyQt5.sip.array[bytes], format: typing.Optional[str] = None) -> bool
        loadFromData(self, data: Union[QByteArray, bytes, bytearray], format: typing.Optional[str] = None) -> bool
        """
        pass
    ...
    def scanLine(self, a0): # real signature unknown; restored from __doc__
        """ scanLine(self, a0: int) -> PyQt5.sip.voidptr """
        pass
    ...
    def setPixelColor(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setPixelColor(self, x: int, y: int, c: Union[QColor, Qt.GlobalColor, QGradient])
        setPixelColor(self, pt: QPoint, c: Union[QColor, Qt.GlobalColor, QGradient])
        """
        pass
