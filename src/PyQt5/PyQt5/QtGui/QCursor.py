...
class QCursor(__sip.simplewrapper):
    ...
    def pos(self, screen=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        pos() -> QPoint
        pos(screen: QScreen) -> QPoint
        """
        pass
    ...
    def setPos(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        setPos(x: int, y: int)
        setPos(p: QPoint)
        setPos(screen: QScreen, x: int, y: int)
        setPos(screen: QScreen, p: QPoint)
        """
        pass
