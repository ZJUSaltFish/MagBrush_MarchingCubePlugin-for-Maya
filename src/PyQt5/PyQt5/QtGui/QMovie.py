...
class QMovie(__PyQt5_QtCore.QObject):
    """
    QMovie(parent: typing.Optional[QObject] = None)
    QMovie(device: QIODevice, format: Union[QByteArray, bytes, bytearray] = QByteArray(), parent: typing.Optional[QObject] = None)
    QMovie(fileName: str, format: Union[QByteArray, bytes, bytearray] = QByteArray(), parent: typing.Optional[QObject] = None)
    """
