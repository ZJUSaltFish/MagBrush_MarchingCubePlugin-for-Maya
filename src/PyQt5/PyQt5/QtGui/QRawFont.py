...
class QRawFont(__sip.simplewrapper):
    """
    QRawFont()
    QRawFont(fileName: str, pixelSize: float, hintingPreference: QFont.HintingPreference = QFont.PreferDefaultHinting)
    ...
    def fontTable(self, tagName): # real signature unknown; restored from __doc__
        """ fontTable(self, tagName: str) -> QByteArray """
        pass
    ...
    def loadFromFile(self, fileName, pixelSize, hintingPreference): # real signature unknown; restored from __doc__
        """ loadFromFile(self, fileName: str, pixelSize: float, hintingPreference: QFont.HintingPreference) """
        pass
