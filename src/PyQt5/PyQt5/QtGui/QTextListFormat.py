...
class QTextListFormat(QTextFormat):
    ...
    def setNumberPrefix(self, np): # real signature unknown; restored from __doc__
        """ setNumberPrefix(self, np: str) """
        pass

    def setNumberSuffix(self, ns): # real signature unknown; restored from __doc__
        """ setNumberSuffix(self, ns: str) """
        pass
