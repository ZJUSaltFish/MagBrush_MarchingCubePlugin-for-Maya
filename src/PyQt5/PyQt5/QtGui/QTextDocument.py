...
class QTextDocument(__PyQt5_QtCore.QObject):
    """
    QTextDocument(parent: typing.Optional[QObject] = None)
    QTextDocument(text: str, parent: typing.Optional[QObject] = None)
    """
    ...
    def clone(self, parent, QObject=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ clone(self, parent: typing.Optional[QObject] = None) -> QTextDocument """
        pass
    ...
    def createObject(self, f): # real signature unknown; restored from __doc__
        """ createObject(self, f: QTextFormat) -> QTextObject """
        return QTextObject
    ...
    def drawContents(self, p, rect=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ drawContents(self, p: QPainter, rect: QRectF = QRectF()) """
        pass
    ...
    def find(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        find(self, subString: str, position: int = 0, options: QTextDocument.FindFlags = 0) -> QTextCursor
        ...
        find(self, subString: str, cursor: QTextCursor, options: QTextDocument.FindFlags = 0) -> QTextCursor
    ...
    def object(self, objectIndex): # real signature unknown; restored from __doc__
        """ object(self, objectIndex: int) -> QTextObject """
        return QTextObject

    def objectForFormat(self, a0): # real signature unknown; restored from __doc__
        """ objectForFormat(self, a0: QTextFormat) -> QTextObject """
        return QTextObject
    ...
    def print(self, printer): # real signature unknown; restored from __doc__
    ...
    def redo(self, cursor=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        redo(self)
        redo(self, cursor: QTextCursor)
        """
        pass
    ...
    def setMarkdown(self, markdown, features, QTextDocument_MarkdownFeatures=None, QTextDocument_MarkdownFeature=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ setMarkdown(self, markdown: str, features: Union[QTextDocument.MarkdownFeatures, QTextDocument.MarkdownFeature] = QTextDocument.MarkdownDialectGitHub) """
        pass
    ...
    def setMetaInformation(self, info, a1): # real signature unknown; restored from __doc__
        """ setMetaInformation(self, info: QTextDocument.MetaInformation, a1: str) """
        pass
    ...
    def undo(self, cursor=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        undo(self)
        undo(self, cursor: QTextCursor)
        """
        pass
