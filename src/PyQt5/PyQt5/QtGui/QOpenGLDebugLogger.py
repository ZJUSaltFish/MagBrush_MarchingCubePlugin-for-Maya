...
class QOpenGLDebugLogger(__PyQt5_QtCore.QObject):
    """ QOpenGLDebugLogger(parent: typing.Optional[QObject] = None) """
    ...
    def pushGroup(self, name, id=0, source=None): # real signature unknown; restored from __doc__
        """ pushGroup(self, name: str, id: int = 0, source: QOpenGLDebugMessage.Source = QOpenGLDebugMessage.ApplicationSource) """
        pass
