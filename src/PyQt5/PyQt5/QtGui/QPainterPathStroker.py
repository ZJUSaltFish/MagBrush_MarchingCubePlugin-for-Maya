...
class QPainterPathStroker(__sip.simplewrapper):
    """
    QPainterPathStroker()
    QPainterPathStroker(pen: Union[QPen, QColor, Qt.GlobalColor, QGradient])
    """
    ...
    def __init__(self, pen=None, QPen=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__ with multiple overloads
        pass
