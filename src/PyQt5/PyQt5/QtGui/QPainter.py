...
class QPainter(__sip.simplewrapper):
    ...
    def begin(self, a0): # real signature unknown; restored from __doc__
        """ begin(self, a0: QPaintDevice) -> bool """
        return False
    ...
    def boundingRect(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        boundingRect(self, rect: QRectF, flags: int, text: str) -> QRectF
        boundingRect(self, rect: QRect, flags: int, text: str) -> QRect
        boundingRect(self, rectangle: QRectF, text: str, option: QTextOption = QTextOption()) -> QRectF
        boundingRect(self, x: int, y: int, w: int, h: int, flags: int, text: str) -> QRect
        """
        pass
    ...
    def drawConvexPolygon(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        drawConvexPolygon(self, points: PyQt5.sip.array[Union[QPointF, QPoint]])
        drawConvexPolygon(self, point: Union[QPointF, QPoint], *a1)
        drawConvexPolygon(self, points: PyQt5.sip.array[QPoint])
        drawConvexPolygon(self, point: QPoint, *a1)
        """
        pass
    ...
    def drawLines(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        drawLines(self, lines: PyQt5.sip.array[QLineF])
        drawLines(self, line: QLineF, *a1)
        drawLines(self, pointPairs: PyQt5.sip.array[Union[QPointF, QPoint]])
        drawLines(self, pointPair: Union[QPointF, QPoint], *a1)
        drawLines(self, lines: PyQt5.sip.array[QLine])
        drawLines(self, line: QLine, *a1)
        drawLines(self, pointPairs: PyQt5.sip.array[QPoint])
        drawLines(self, pointPair: QPoint, *a1)
        """
        pass
    ...
    def drawPixmapFragments(self, fragments, QPainter_PixmapFragment=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ drawPixmapFragments(self, fragments: PyQt5.sip.array[QPainter.PixmapFragment], pixmap: QPixmap, hints: QPainter.PixmapFragmentHints = 0) """
        pass
    ...
    def drawPoints(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        drawPoints(self, points: PyQt5.sip.array[Union[QPointF, QPoint]])
        drawPoints(self, point: Union[QPointF, QPoint], *a1)
        drawPoints(self, points: PyQt5.sip.array[QPoint])
        drawPoints(self, point: QPoint, *a1)
        """
        pass
    ...
    def drawPolygon(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        drawPolygon(self, points: PyQt5.sip.array[Union[QPointF, QPoint]], fillRule: Qt.FillRule = Qt.OddEvenFill)
        drawPolygon(self, point: Union[QPointF, QPoint], *a1)
        drawPolygon(self, points: PyQt5.sip.array[QPoint], fillRule: Qt.FillRule = Qt.OddEvenFill)
        drawPolygon(self, point: QPoint, *a1)
        """
        pass
    ...
    def drawPolyline(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        drawPolyline(self, points: PyQt5.sip.array[Union[QPointF, QPoint]])
        drawPolyline(self, point: Union[QPointF, QPoint], *a1)
        drawPolyline(self, points: PyQt5.sip.array[QPoint])
        drawPolyline(self, point: QPoint, *a1)
        """
        pass
    ...
    def drawRects(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        drawRects(self, rects: PyQt5.sip.array[QRectF])
        drawRects(self, rect: QRectF, *a1)
        drawRects(self, rects: PyQt5.sip.array[QRect])
        drawRects(self, rect: QRect, *a1)
        """
        pass
    ...
    def drawText(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        drawText(self, p: Union[QPointF, QPoint], s: str)
        drawText(self, rectangle: QRectF, flags: int, text: str) -> QRectF
        drawText(self, rectangle: QRect, flags: int, text: str) -> QRect
        drawText(self, rectangle: QRectF, text: str, option: QTextOption = QTextOption())
        drawText(self, p: QPoint, s: str)
        drawText(self, x: int, y: int, width: int, height: int, flags: int, text: str) -> QRect
    ...
    def fillPath(self, path, brush, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ fillPath(self, path: QPainterPath, brush: Union[QBrush, QColor, Qt.GlobalColor, QGradient]) """
        pass

    def fillRect(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        fillRect(self, a0: QRectF, a1: Union[QBrush, QColor, Qt.GlobalColor, QGradient])
        fillRect(self, a0: QRect, a1: Union[QBrush, QColor, Qt.GlobalColor, QGradient])
        fillRect(self, x: int, y: int, w: int, h: int, b: Union[QBrush, QColor, Qt.GlobalColor, QGradient])
        fillRect(self, a0: QRectF, color: Union[QColor, Qt.GlobalColor, QGradient])
        fillRect(self, a0: QRect, color: Union[QColor, Qt.GlobalColor, QGradient])
        fillRect(self, x: int, y: int, w: int, h: int, b: Union[QColor, Qt.GlobalColor, QGradient])
    ...
    def setBackground(self, bg, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setBackground(self, bg: Union[QBrush, QColor, Qt.GlobalColor, QGradient]) """
        pass
    ...
    def setPen(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setPen(self, color: Union[QColor, Qt.GlobalColor, QGradient])
    ...
    def strokePath(self, path, pen, QPen=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ strokePath(self, path: QPainterPath, pen: Union[QPen, QColor, Qt.GlobalColor, QGradient]) """
        pass
