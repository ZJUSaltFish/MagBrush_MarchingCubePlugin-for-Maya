...
class QOpenGLShaderProgram(__PyQt5_QtCore.QObject):
    """ QOpenGLShaderProgram(parent: typing.Optional[QObject] = None) """
    def addCacheableShaderFromSourceCode(self, type, QOpenGLShader_ShaderType=None, QOpenGLShader_ShaderTypeBit=None, *args, **kwargs): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        addCacheableShaderFromSourceCode(self, type: Union[QOpenGLShader.ShaderType, QOpenGLShader.ShaderTypeBit], source: str) -> bool
        """
        pass
    ...
    def addCacheableShaderFromSourceFile(self, type, QOpenGLShader_ShaderType=None, QOpenGLShader_ShaderTypeBit=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ addCacheableShaderFromSourceFile(self, type: Union[QOpenGLShader.ShaderType, QOpenGLShader.ShaderTypeBit], fileName: str) -> bool """
        pass

    def addShader(self, shader): # real signature unknown; restored from __doc__
        """ addShader(self, shader: QOpenGLShader) -> bool """
        return False
    ...
    def addShaderFromSourceCode(self, type, QOpenGLShader_ShaderType=None, QOpenGLShader_ShaderTypeBit=None, *args, **kwargs): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        addShaderFromSourceCode(self, type: Union[QOpenGLShader.ShaderType, QOpenGLShader.ShaderTypeBit], source: str) -> bool
        """
        pass
    ...
    def addShaderFromSourceFile(self, type, QOpenGLShader_ShaderType=None, QOpenGLShader_ShaderTypeBit=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ addShaderFromSourceFile(self, type: Union[QOpenGLShader.ShaderType, QOpenGLShader.ShaderTypeBit], fileName: str) -> bool """
        pass

    def attributeLocation(self, name, QByteArray=None, bytes=None, bytearray=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def disableAttributeArray(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        disableAttributeArray(self, name: str)
        """
        pass
    ...
    def enableAttributeArray(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        enableAttributeArray(self, name: str)
        """
        pass
    ...
    def hasOpenGLShaderPrograms(self, context, QOpenGLContext=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ hasOpenGLShaderPrograms(context: typing.Optional[QOpenGLContext] = None) -> bool """
        pass
    ...
    def removeShader(self, shader): # real signature unknown; restored from __doc__
        """ removeShader(self, shader: QOpenGLShader) """
        pass
    ...
    def setAttributeArray(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        setAttributeArray(self, name: str, values: PYQT_SHADER_ATTRIBUTE_ARRAY)
        """
        pass
    ...
    def setAttributeBuffer(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        setAttributeBuffer(self, name: str, type: int, offset: int, tupleSize: int, stride: int = 0)
        """
        pass
    ...
    def setAttributeValue(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        setAttributeValue(self, location: int, value: Union[QColor, Qt.GlobalColor, QGradient])
        setAttributeValue(self, name: str, value: float)
        setAttributeValue(self, name: str, x: float, y: float)
        setAttributeValue(self, name: str, x: float, y: float, z: float)
        setAttributeValue(self, name: str, x: float, y: float, z: float, w: float)
        setAttributeValue(self, name: str, value: QVector2D)
        setAttributeValue(self, name: str, value: QVector3D)
        setAttributeValue(self, name: str, value: QVector4D)
        setAttributeValue(self, name: str, value: Union[QColor, Qt.GlobalColor, QGradient])
        """
        pass
    ...
    def setUniformValue(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        setUniformValue(self, location: int, color: Union[QColor, Qt.GlobalColor, QGradient])
        ...
        setUniformValue(self, name: str, value: int)
        setUniformValue(self, name: str, value: float)
        setUniformValue(self, name: str, x: float, y: float)
        setUniformValue(self, name: str, x: float, y: float, z: float)
        setUniformValue(self, name: str, x: float, y: float, z: float, w: float)
        setUniformValue(self, name: str, value: QVector2D)
        setUniformValue(self, name: str, value: QVector3D)
        setUniformValue(self, name: str, value: QVector4D)
        setUniformValue(self, name: str, color: Union[QColor, Qt.GlobalColor, QGradient])
        setUniformValue(self, name: str, point: QPoint)
        setUniformValue(self, name: str, point: Union[QPointF, QPoint])
        setUniformValue(self, name: str, size: QSize)
        setUniformValue(self, name: str, size: QSizeF)
        setUniformValue(self, name: str, value: QMatrix2x2)
        setUniformValue(self, name: str, value: QMatrix2x3)
        setUniformValue(self, name: str, value: QMatrix2x4)
        setUniformValue(self, name: str, value: QMatrix3x2)
        setUniformValue(self, name: str, value: QMatrix3x3)
        setUniformValue(self, name: str, value: QMatrix3x4)
        setUniformValue(self, name: str, value: QMatrix4x2)
        setUniformValue(self, name: str, value: QMatrix4x3)
        setUniformValue(self, name: str, value: QMatrix4x4)
        setUniformValue(self, name: str, value: QTransform)
        """
        pass
    ...
    def setUniformValueArray(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        setUniformValueArray(self, name: str, values: PYQT_SHADER_UNIFORM_VALUE_ARRAY)
        """
        pass
    ...
    def uniformLocation(self, name, QByteArray=None, bytes=None, bytearray=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
