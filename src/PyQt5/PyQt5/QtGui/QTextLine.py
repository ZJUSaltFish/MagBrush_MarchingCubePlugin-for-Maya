...
class QTextLine(__sip.simplewrapper):
    ...
    def draw(self, painter, position, QPointF=None, QPoint=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ draw(self, painter: QPainter, position: Union[QPointF, QPoint], selection: typing.Optional[QTextLayout.FormatRange] = None) """
        pass
