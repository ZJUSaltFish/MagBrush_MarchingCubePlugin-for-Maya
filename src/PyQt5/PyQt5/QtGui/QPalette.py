...
class QPalette(__sip.simplewrapper):
    ...
    def setBrush(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setBrush(self, cg: QPalette.ColorGroup, cr: QPalette.ColorRole, brush: Union[QBrush, QColor, Qt.GlobalColor, QGradient])
        setBrush(self, acr: QPalette.ColorRole, abrush: Union[QBrush, QColor, Qt.GlobalColor, QGradient])
        """
        pass

    def setColor(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setColor(self, acg: QPalette.ColorGroup, acr: QPalette.ColorRole, acolor: Union[QColor, Qt.GlobalColor, QGradient])
        setColor(self, acr: QPalette.ColorRole, acolor: Union[QColor, Qt.GlobalColor, QGradient])
        """
        pass

    def setColorGroup(self, cr, foreground, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
