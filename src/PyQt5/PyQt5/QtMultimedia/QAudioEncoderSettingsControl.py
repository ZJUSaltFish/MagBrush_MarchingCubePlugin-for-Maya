...
class QAudioEncoderSettingsControl(QMediaControl):
    """ QAudioEncoderSettingsControl(parent: typing.Optional[QObject] = None) """
    ...
    def codecDescription(self, codecName): # real signature unknown; restored from __doc__
        """ codecDescription(self, codecName: str) -> str """
        return ""
    ...
    def supportedSampleRates(self, settings): # real signature unknown; restored from __doc__
        """ supportedSampleRates(self, settings: QAudioEncoderSettings) -> Tuple[List[int], bool] """
        pass
