...
class QSound(__PyQt5_QtCore.QObject):
    """ QSound(filename: str, parent: typing.Optional[QObject] = None) """
    ...
    def play(self, filename=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        play(filename: str)
        play(self)
        """
    ...
    def __init__(self, filename, parent, QObject=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        pass
