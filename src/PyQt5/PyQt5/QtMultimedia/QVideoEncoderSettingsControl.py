...
class QVideoEncoderSettingsControl(QMediaControl):
    """ QVideoEncoderSettingsControl(parent: typing.Optional[QObject] = None) """
    ...
    def supportedFrameRates(self, settings): # real signature unknown; restored from __doc__
        """ supportedFrameRates(self, settings: QVideoEncoderSettings) -> Tuple[List[float], bool] """
        pass

    def supportedResolutions(self, settings): # real signature unknown; restored from __doc__
        """ supportedResolutions(self, settings: QVideoEncoderSettings) -> Tuple[List[QSize], bool] """
        pass
    ...
    def videoCodecDescription(self, codec): # real signature unknown; restored from __doc__
        """ videoCodecDescription(self, codec: str) -> str """
        return ""
