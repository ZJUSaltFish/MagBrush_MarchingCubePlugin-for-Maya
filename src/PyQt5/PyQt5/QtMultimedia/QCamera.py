...
class QCamera(QMediaObject):
    ...
    QCamera(device: Union[QByteArray, bytes, bytearray], parent: typing.Optional[QObject] = None)
    QCamera(cameraInfo: QCameraInfo, parent: typing.Optional[QObject] = None)
    QCamera(position: QCamera.Position, parent: typing.Optional[QObject] = None)
    """
    ...
    def setViewfinder(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setViewfinder(self, viewfinder: QVideoWidget)
        setViewfinder(self, viewfinder: QGraphicsVideoItem)
        setViewfinder(self, surface: QAbstractVideoSurface)
        """
        pass
