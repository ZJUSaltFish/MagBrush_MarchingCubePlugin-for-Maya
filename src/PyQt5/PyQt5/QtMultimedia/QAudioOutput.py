...
class QAudioOutput(__PyQt5_QtCore.QObject):
    """
    QAudioOutput(format: QAudioFormat = QAudioFormat(), parent: typing.Optional[QObject] = None)
    QAudioOutput(audioDevice: QAudioDeviceInfo, format: QAudioFormat = QAudioFormat(), parent: typing.Optional[QObject] = None)
    """
