...
class QMediaPlayerControl(QMediaControl):
    """ QMediaPlayerControl(parent: typing.Optional[QObject] = None) """
    ...
    def setMedia(self, media, stream): # real signature unknown; restored from __doc__
        """ setMedia(self, media: QMediaContent, stream: QIODevice) """
        pass
