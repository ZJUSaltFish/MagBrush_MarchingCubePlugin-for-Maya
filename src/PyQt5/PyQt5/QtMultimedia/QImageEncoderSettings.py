...
class QImageEncoderSettings(__sip.simplewrapper):
    ...
    QImageEncoderSettings(other: QImageEncoderSettings)
    """
    ...
    def encodingOption(self, option): # real signature unknown; restored from __doc__
        """ encodingOption(self, option: str) -> Any """
        pass
    ...
    def setCodec(self, a0): # real signature unknown; restored from __doc__
        """ setCodec(self, a0: str) """
        pass

    def setEncodingOption(self, option, value): # real signature unknown; restored from __doc__
        """ setEncodingOption(self, option: str, value: Any) """
        pass
