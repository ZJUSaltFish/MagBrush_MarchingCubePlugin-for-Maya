...
class QVideoFrame(__sip.simplewrapper):
    """
    QVideoFrame()
    QVideoFrame(buffer: QAbstractVideoBuffer, size: QSize, format: QVideoFrame.PixelFormat)
    ...
    def bits(self, plane=None): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        bits(self, plane: int) -> PyQt5.sip.voidptr
        """
        pass

    def buffer(self): # real signature unknown; restored from __doc__
        """ buffer(self) -> QAbstractVideoBuffer """
        return QAbstractVideoBuffer
