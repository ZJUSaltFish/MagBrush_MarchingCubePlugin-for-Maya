...
# from D:\Maya2024\Python\lib\site-packages\PyQt5\QtXmlPatterns.pyd
# by generator 1.147
# no doc
...
class QAbstractMessageHandler(__PyQt5_QtCore.QObject):
    """ QAbstractMessageHandler(parent: typing.Optional[QObject] = None) """
    ...
    def handleMessage(self, type, description, identifier, sourceLocation): # real signature unknown; restored from __doc__
        """ handleMessage(self, type: QtMsgType, description: str, identifier: QUrl, sourceLocation: QSourceLocation) """
        pass
    ...
    def message(self, type, description, identifier=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ message(self, type: QtMsgType, description: str, identifier: QUrl = QUrl(), sourceLocation: QSourceLocation = QSourceLocation()) """
        pass
...
class QAbstractUriResolver(__PyQt5_QtCore.QObject):
    """ QAbstractUriResolver(parent: typing.Optional[QObject] = None) """
    def childEvent(self, *args, **kwargs): # real signature unknown
        pass
...
class QAbstractXmlNodeModel(__sip.simplewrapper):
    ...
    def createIndex(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        createIndex(self, pointer: object, additionalData: int = 0) -> QXmlNodeModelIndex
        """
...
class QAbstractXmlReceiver(__sip.simplewrapper):
    ...
    def processingInstruction(self, target, value): # real signature unknown; restored from __doc__
        """ processingInstruction(self, target: QXmlName, value: str) """
        pass
...
class QXmlSerializer(QAbstractXmlReceiver):
    """ QXmlSerializer(query: QXmlQuery, outputDevice: QIODevice) """
    def atomicValue(self, value): # real signature unknown; restored from __doc__
        """ atomicValue(self, value: Any) """
        pass
    ...
    def processingInstruction(self, name, value): # real signature unknown; restored from __doc__
        """ processingInstruction(self, name: QXmlName, value: str) """
        pass
...
class QXmlFormatter(QXmlSerializer):
    """ QXmlFormatter(query: QXmlQuery, outputDevice: QIODevice) """
    def atomicValue(self, value): # real signature unknown; restored from __doc__
        """ atomicValue(self, value: Any) """
        pass
...
class QXmlName(__sip.simplewrapper):
    """
    QXmlName()
    QXmlName(namePool: QXmlNamePool, localName: str, namespaceUri: str = '', prefix: str = '')
    QXmlName(other: QXmlName)
    """
    def fromClarkName(self, clarkName, namePool): # real signature unknown; restored from __doc__
        """ fromClarkName(clarkName: str, namePool: QXmlNamePool) -> QXmlName """
        return QXmlName
...
class QXmlQuery(__sip.simplewrapper):
    ...
    def bindVariable(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        bindVariable(self, name: QXmlName, a1: QIODevice)
        bindVariable(self, name: QXmlName, query: QXmlQuery)
        bindVariable(self, localName: str, value: QXmlItem)
        bindVariable(self, localName: str, a1: QIODevice)
        bindVariable(self, localName: str, query: QXmlQuery)
        """
        pass

    def evaluateTo(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        evaluateTo(self, result: QXmlResultItems)
        evaluateTo(self, callback: QAbstractXmlReceiver) -> bool
        evaluateTo(self, target: QIODevice) -> bool
        """
        return False
    ...
    def setFocus(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        setFocus(self, document: QIODevice) -> bool
        setFocus(self, focus: str) -> bool
        """
        return False

    def setInitialTemplateName(self, name): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setInitialTemplateName(self, name: QXmlName)
        setInitialTemplateName(self, name: str)
        """
        pass

    def setMessageHandler(self, messageHandler): # real signature unknown; restored from __doc__
        """ setMessageHandler(self, messageHandler: QAbstractMessageHandler) """
        pass

    def setNetworkAccessManager(self, newManager): # real signature unknown; restored from __doc__
        """ setNetworkAccessManager(self, newManager: QNetworkAccessManager) """
        pass

    def setQuery(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setQuery(self, sourceCode: str, documentUri: QUrl = QUrl())
        setQuery(self, sourceCode: QIODevice, documentUri: QUrl = QUrl())
    ...
    def setUriResolver(self, resolver): # real signature unknown; restored from __doc__
        """ setUriResolver(self, resolver: QAbstractUriResolver) """
        pass
...
class QXmlSchema(__sip.simplewrapper):
    ...
    def load(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        load(self, source: QIODevice, documentUri: QUrl = QUrl()) -> bool
    ...
    def setMessageHandler(self, handler): # real signature unknown; restored from __doc__
        """ setMessageHandler(self, handler: QAbstractMessageHandler) """
        pass

    def setNetworkAccessManager(self, networkmanager): # real signature unknown; restored from __doc__
        """ setNetworkAccessManager(self, networkmanager: QNetworkAccessManager) """
        pass
...
class QXmlSchemaValidator(__sip.simplewrapper):
    ...
    def validate(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        validate(self, source: QIODevice, documentUri: QUrl = QUrl()) -> bool
