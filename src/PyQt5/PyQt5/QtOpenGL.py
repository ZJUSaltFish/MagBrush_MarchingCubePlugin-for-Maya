...
# from D:\Maya2024\Python\lib\site-packages\PyQt5\QtOpenGL.pyd
# by generator 1.147
# no doc
...
class QGLContext(__sip.wrapper):
    ...
    def areSharing(self, context1, context2): # real signature unknown; restored from __doc__
        """ areSharing(context1: QGLContext, context2: QGLContext) -> bool """
        return False
    ...
    def chooseContext(self, shareContext, QGLContext=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ chooseContext(self, shareContext: typing.Optional[QGLContext] = None) -> bool """
        pass

    def create(self, shareContext, QGLContext=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ create(self, shareContext: typing.Optional[QGLContext] = None) -> bool """
        pass
    ...
    def getProcAddress(self, proc): # real signature unknown; restored from __doc__
        """ getProcAddress(self, proc: str) -> PyQt5.sip.voidptr """
        pass
...
class QGLWidget(__PyQt5_QtWidgets.QWidget):
    """
    QGLWidget(parent: typing.Optional[QWidget] = None, shareWidget: typing.Optional[QGLWidget] = None, flags: Union[Qt.WindowFlags, Qt.WindowType] = Qt.WindowFlags())
    QGLWidget(context: QGLContext, parent: typing.Optional[QWidget] = None, shareWidget: typing.Optional[QGLWidget] = None, flags: Union[Qt.WindowFlags, Qt.WindowType] = Qt.WindowFlags())
    QGLWidget(format: QGLFormat, parent: typing.Optional[QWidget] = None, shareWidget: typing.Optional[QGLWidget] = None, flags: Union[Qt.WindowFlags, Qt.WindowType] = Qt.WindowFlags())
    """
    ...
    def renderText(self, x, y, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        renderText(self, x: int, y: int, str: str, font: QFont = QFont())
        renderText(self, x: float, y: float, z: float, str: str, font: QFont = QFont())
        """
        pass
    ...
    def setContext(self, context, shareContext, QGLContext=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ setContext(self, context: QGLContext, shareContext: typing.Optional[QGLContext] = None, deleteOldContext: bool = True) """
        pass
