...
class QCalendar(__sip.simplewrapper):
    ...
    def dateTimeToString(self, format, datetime, QDateTime=None, datetime_datetime=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ dateTimeToString(self, format: str, datetime: Union[QDateTime, datetime.datetime], dateOnly: Union[QDate, datetime.date], timeOnly: Union[QTime, datetime.time], locale: QLocale) -> str """
        pass
