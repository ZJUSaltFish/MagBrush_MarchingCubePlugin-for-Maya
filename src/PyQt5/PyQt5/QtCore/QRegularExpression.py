...
class QRegularExpression(__sip.simplewrapper):
    """
    QRegularExpression()
    QRegularExpression(pattern: str, options: Union[QRegularExpression.PatternOptions, QRegularExpression.PatternOption] = QRegularExpression.NoPatternOption)
    ...
    def globalMatch(self, subject, offset=0, matchType=None, matchOptions, QRegularExpression_MatchOptions=None, QRegularExpression_MatchOption=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ globalMatch(self, subject: str, offset: int = 0, matchType: QRegularExpression.MatchType = QRegularExpression.NormalMatch, matchOptions: Union[QRegularExpression.MatchOptions, QRegularExpression.MatchOption] = QRegularExpression.NoMatchOption) -> QRegularExpressionMatchIterator """
        pass
    ...
    def match(self, subject, offset=0, matchType=None, matchOptions, QRegularExpression_MatchOptions=None, QRegularExpression_MatchOption=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ match(self, subject: str, offset: int = 0, matchType: QRegularExpression.MatchType = QRegularExpression.NormalMatch, matchOptions: Union[QRegularExpression.MatchOptions, QRegularExpression.MatchOption] = QRegularExpression.NoMatchOption) -> QRegularExpressionMatch """
        pass
