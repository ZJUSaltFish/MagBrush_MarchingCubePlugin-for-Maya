...
class QLineF(__sip.simplewrapper):
    ...
    def intersect(self, l, intersectionPoint, QPointF=None, QPoint=None): # real signature unknown; restored from __doc__
        """ intersect(self, l: QLineF, intersectionPoint: Union[QPointF, QPoint]) -> QLineF.IntersectType """
        pass

    def intersects(self, l): # real signature unknown; restored from __doc__
        """ intersects(self, l: QLineF) -> Tuple[QLineF.IntersectType, QPointF] """
        pass
