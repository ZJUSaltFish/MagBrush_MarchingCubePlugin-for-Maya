...
class QFileSystemWatcher(QObject):
    """
    QFileSystemWatcher(parent: typing.Optional[QObject] = None)
    QFileSystemWatcher(paths: Iterable[str], parent: typing.Optional[QObject] = None)
    """
    ...
    def addPaths(self, files, p_str=None): # real signature unknown; restored from __doc__
        """ addPaths(self, files: Iterable[str]) -> List[str] """
        return []
    ...
    def removePaths(self, files, p_str=None): # real signature unknown; restored from __doc__
        """ removePaths(self, files: Iterable[str]) -> List[str] """
        return []
