...
class QJsonValue(__sip.simplewrapper):
    ...
    QJsonValue(other: Union[QJsonValue, QJsonValue.Type, Dict[str, QJsonValue], bool, int, float, None, str])
    """
    ...
    def toArray(self, defaultValue=None, *args=None, **kwargs=None): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        toArray(self, defaultValue: Iterable[Union[QJsonValue, QJsonValue.Type, Dict[str, QJsonValue], bool, int, float, None, str]]) -> List[QJsonValue]
        """
        return []
    ...
    def toObject(self, defaultValue=None, p_str=None, QJsonValue=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        toObject(self) -> Dict[str, QJsonValue]
        toObject(self, defaultValue: Dict[str, QJsonValue]) -> Dict[str, QJsonValue]
        """
        return {}

    def toString(self, defaultValue=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        toString(self) -> str
