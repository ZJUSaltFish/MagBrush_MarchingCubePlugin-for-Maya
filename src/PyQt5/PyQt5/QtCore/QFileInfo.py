...
class QFileInfo(__sip.simplewrapper):
    ...
    def exists(self, file=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        exists(self) -> bool
    ...
    def setFile(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setFile(self, file: str)
        setFile(self, file: QFile)
        setFile(self, dir: QDir, file: str)
        """
        pass
