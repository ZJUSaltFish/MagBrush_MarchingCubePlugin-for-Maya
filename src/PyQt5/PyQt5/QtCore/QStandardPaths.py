...
class QStandardPaths(__sip.simplewrapper):
    ...
    def findExecutable(self, executableName, paths, p_str=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ findExecutable(executableName: str, paths: Iterable[str] = []) -> str """
        pass

    def locate(self, type, fileName, options=None): # real signature unknown; restored from __doc__
        """ locate(type: QStandardPaths.StandardLocation, fileName: str, options: QStandardPaths.LocateOptions = QStandardPaths.LocateFile) -> str """
        return ""

    def locateAll(self, type, fileName, options=None): # real signature unknown; restored from __doc__
        """ locateAll(type: QStandardPaths.StandardLocation, fileName: str, options: QStandardPaths.LocateOptions = QStandardPaths.LocateFile) -> List[str] """
        return []
