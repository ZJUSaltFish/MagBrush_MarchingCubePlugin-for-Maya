...
class QUuid(__sip.simplewrapper):
    ...
    def createUuidV3(self, ns, baseData, QByteArray=None, bytes=None, bytearray=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        createUuidV3(ns: QUuid, baseData: Union[QByteArray, bytes, bytearray]) -> QUuid
        createUuidV3(ns: QUuid, baseData: str) -> QUuid
        """
        return QUuid

    def createUuidV5(self, ns, baseData, QByteArray=None, bytes=None, bytearray=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        createUuidV5(ns: QUuid, baseData: Union[QByteArray, bytes, bytearray]) -> QUuid
        createUuidV5(ns: QUuid, baseData: str) -> QUuid
        """
        return QUuid
