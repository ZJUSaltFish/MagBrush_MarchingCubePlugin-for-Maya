...
class QSharedMemory(QObject):
    """
    QSharedMemory(parent: typing.Optional[QObject] = None)
    QSharedMemory(key: str, parent: typing.Optional[QObject] = None)
    """
    ...
    def setNativeKey(self, key): # real signature unknown; restored from __doc__
        """ setNativeKey(self, key: str) """
        pass
