...
class QThreadPool(QObject):
    """ QThreadPool(parent: typing.Optional[QObject] = None) """
    ...
    def cancel(self, runnable): # real signature unknown; restored from __doc__
        """ cancel(self, runnable: QRunnable) """
        pass
    ...
    def contains(self, thread): # real signature unknown; restored from __doc__
        """ contains(self, thread: QThread) -> bool """
        return False
    ...
    def start(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        start(self, runnable: QRunnable, priority: int = 0)
