...
class QAbstractEventDispatcher(QObject):
    """ QAbstractEventDispatcher(parent: typing.Optional[QObject] = None) """
    ...
    def filterNativeEvent(self, eventType, QByteArray=None, bytes=None, bytearray=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ filterNativeEvent(self, eventType: Union[QByteArray, bytes, bytearray], message: PyQt5.sip.voidptr) -> Tuple[bool, int] """
        pass
    ...
    def instance(self, thread, QThread=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ instance(thread: typing.Optional[QThread] = None) -> QAbstractEventDispatcher """
        pass
    ...
    def registeredTimers(self, p_object): # real signature unknown; restored from __doc__
        """ registeredTimers(self, object: QObject) -> List[QAbstractEventDispatcher.TimerInfo] """
        return []

    def registerEventNotifier(self, notifier): # real signature unknown; restored from __doc__
        """ registerEventNotifier(self, notifier: QWinEventNotifier) -> bool """
        return False

    def registerSocketNotifier(self, notifier): # real signature unknown; restored from __doc__
        """ registerSocketNotifier(self, notifier: QSocketNotifier) """
        pass

    def registerTimer(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        registerTimer(self, interval: int, timerType: Qt.TimerType, object: QObject) -> int
        registerTimer(self, timerId: int, interval: int, timerType: Qt.TimerType, object: QObject)
        """
        return 0
    ...
    def unregisterEventNotifier(self, notifier): # real signature unknown; restored from __doc__
        """ unregisterEventNotifier(self, notifier: QWinEventNotifier) """
        pass

    def unregisterSocketNotifier(self, notifier): # real signature unknown; restored from __doc__
        """ unregisterSocketNotifier(self, notifier: QSocketNotifier) """
        pass
    ...
    def unregisterTimers(self, p_object): # real signature unknown; restored from __doc__
        """ unregisterTimers(self, object: QObject) -> bool """
        return False
