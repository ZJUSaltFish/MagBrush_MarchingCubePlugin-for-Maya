...
class QBuffer(QIODevice):
    """
    QBuffer(parent: typing.Optional[QObject] = None)
    QBuffer(byteArray: QByteArray, parent: typing.Optional[QObject] = None)
    """
    ...
    def setData(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        setData(self, adata: PyQt5.sip.array[bytes])
        """
        pass
