...
class QDirIterator(__sip.simplewrapper):
    ...
    QDirIterator(path: str, flags: QDirIterator.IteratorFlags = QDirIterator.NoIteratorFlags)
    QDirIterator(path: str, filters: QDir.Filters, flags: QDirIterator.IteratorFlags = QDirIterator.NoIteratorFlags)
    QDirIterator(path: str, nameFilters: Iterable[str], filters: QDir.Filters = QDir.NoFilter, flags: QDirIterator.IteratorFlags = QDirIterator.NoIteratorFlags)
    """
