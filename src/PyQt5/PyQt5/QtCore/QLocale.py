...
class QLocale(__sip.simplewrapper):
    ...
    def createSeparatedList(self, p_list, p_str=None): # real signature unknown; restored from __doc__
        """ createSeparatedList(self, list: Iterable[str]) -> str """
        return ""
    ...
    def quoteString(self, p_str, style=None): # real signature unknown; restored from __doc__
        """ quoteString(self, str: str, style: QLocale.QuotationStyle = QLocale.StandardQuotation) -> str """
        return ""
    ...
    def toCurrencyString(self, value, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        toCurrencyString(self, value: float, symbol: str = '') -> str
        toCurrencyString(self, value: float, symbol: str, precision: int) -> str
        toCurrencyString(self, value: int, symbol: str = '') -> str
        """
        return ""

    def toDate(self, string, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        toDate(self, string: str, format: QLocale.FormatType = QLocale.LongFormat) -> QDate
        toDate(self, string: str, format: str) -> QDate
        toDate(self, string: str, format: QLocale.FormatType, cal: QCalendar) -> QDate
        toDate(self, string: str, format: str, cal: QCalendar) -> QDate
        """
        return QDate

    def toDateTime(self, string, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        toDateTime(self, string: str, format: QLocale.FormatType = QLocale.LongFormat) -> QDateTime
        toDateTime(self, string: str, format: str) -> QDateTime
        toDateTime(self, string: str, format: QLocale.FormatType, cal: QCalendar) -> QDateTime
        toDateTime(self, string: str, format: str, cal: QCalendar) -> QDateTime
        """
        return QDateTime

    def toDouble(self, s): # real signature unknown; restored from __doc__
        """ toDouble(self, s: str) -> Tuple[float, bool] """
        pass

    def toFloat(self, s): # real signature unknown; restored from __doc__
        """ toFloat(self, s: str) -> Tuple[float, bool] """
        pass

    def toInt(self, s): # real signature unknown; restored from __doc__
        """ toInt(self, s: str) -> Tuple[int, bool] """
        pass

    def toLong(self, s): # real signature unknown; restored from __doc__
        """ toLong(self, s: str) -> Tuple[int, bool] """
        pass

    def toLongLong(self, s): # real signature unknown; restored from __doc__
        """ toLongLong(self, s: str) -> Tuple[int, bool] """
        pass
    ...
    def toShort(self, s): # real signature unknown; restored from __doc__
        """ toShort(self, s: str) -> Tuple[int, bool] """
        pass
    ...
    def toString(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        toString(self, dateTime: Union[QDateTime, datetime.datetime], format: str) -> str
        toString(self, dateTime: Union[QDateTime, datetime.datetime], formatStr: str, cal: QCalendar) -> str
        ...
        toString(self, date: Union[QDate, datetime.date], formatStr: str) -> str
        toString(self, date: Union[QDate, datetime.date], formatStr: str, cal: QCalendar) -> str
        ...
        toString(self, time: Union[QTime, datetime.time], formatStr: str) -> str
        toString(self, time: Union[QTime, datetime.time], format: QLocale.FormatType = QLocale.LongFormat) -> str
        toString(self, i: int) -> str
        """
        return ""

    def toTime(self, string, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        toTime(self, string: str, format: QLocale.FormatType = QLocale.LongFormat) -> QTime
        toTime(self, string: str, format: str) -> QTime
        toTime(self, string: str, format: QLocale.FormatType, cal: QCalendar) -> QTime
        toTime(self, string: str, format: str, cal: QCalendar) -> QTime
        """
        return QTime

    def toUInt(self, s): # real signature unknown; restored from __doc__
        """ toUInt(self, s: str) -> Tuple[int, bool] """
        pass

    def toULong(self, s): # real signature unknown; restored from __doc__
        """ toULong(self, s: str) -> Tuple[int, bool] """
        pass

    def toULongLong(self, s): # real signature unknown; restored from __doc__
        """ toULongLong(self, s: str) -> Tuple[int, bool] """
        pass
    ...
    def toUShort(self, s): # real signature unknown; restored from __doc__
        """ toUShort(self, s: str) -> Tuple[int, bool] """
        pass
