...
class QFileSelector(QObject):
    """ QFileSelector(parent: typing.Optional[QObject] = None) """
    ...
    def select(self, filePath): # real signature unknown; restored from __doc__ with multiple overloads
        """
        select(self, filePath: str) -> str
    ...
    def setExtraSelectors(self, p_list, p_str=None): # real signature unknown; restored from __doc__
        """ setExtraSelectors(self, list: Iterable[str]) """
        pass
