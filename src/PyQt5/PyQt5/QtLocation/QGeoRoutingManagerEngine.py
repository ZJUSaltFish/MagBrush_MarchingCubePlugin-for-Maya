...
class QGeoRoutingManagerEngine(__PyQt5_QtCore.QObject):
    """ QGeoRoutingManagerEngine(parameters: Dict[str, Any], parent: typing.Optional[QObject] = None) """
    def calculateRoute(self, request): # real signature unknown; restored from __doc__
        """ calculateRoute(self, request: QGeoRouteRequest) -> QGeoRouteReply """
    ...
    def updateRoute(self, route, position): # real signature unknown; restored from __doc__
        """ updateRoute(self, route: QGeoRoute, position: QGeoCoordinate) -> QGeoRouteReply """
        return QGeoRouteReply
