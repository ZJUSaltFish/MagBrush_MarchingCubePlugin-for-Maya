...
class QGeoCodingManagerEngine(__PyQt5_QtCore.QObject):
    """ QGeoCodingManagerEngine(parameters: Dict[str, Any], parent: typing.Optional[QObject] = None) """
    ...
    def geocode(self, address, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        geocode(self, address: QGeoAddress, bounds: QGeoShape) -> QGeoCodeReply
        geocode(self, address: str, limit: int, offset: int, bounds: QGeoShape) -> QGeoCodeReply
        """
    ...
    def reverseGeocode(self, coordinate, bounds): # real signature unknown; restored from __doc__
        """ reverseGeocode(self, coordinate: QGeoCoordinate, bounds: QGeoShape) -> QGeoCodeReply """
        return QGeoCodeReply
