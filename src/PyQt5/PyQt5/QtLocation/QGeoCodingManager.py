...
class QGeoCodingManager(__PyQt5_QtCore.QObject):
    ...
    def geocode(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        geocode(self, address: QGeoAddress, bounds: QGeoShape = QGeoShape()) -> QGeoCodeReply
        geocode(self, searchString: str, limit: int = -1, offset: int = 0, bounds: QGeoShape = QGeoShape()) -> QGeoCodeReply
        """
        pass
    ...
    def reverseGeocode(self, coordinate, bounds=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ reverseGeocode(self, coordinate: QGeoCoordinate, bounds: QGeoShape = QGeoShape()) -> QGeoCodeReply """
        pass
