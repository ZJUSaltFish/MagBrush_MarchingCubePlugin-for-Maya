...
class QGeoCodeReply(__PyQt5_QtCore.QObject):
    """
    QGeoCodeReply(error: QGeoCodeReply.Error, errorString: str, parent: typing.Optional[QObject] = None)
    QGeoCodeReply(parent: typing.Optional[QObject] = None)
    """
    ...
    def setError(self, error, errorString): # real signature unknown; restored from __doc__
        """ setError(self, error: QGeoCodeReply.Error, errorString: str) """
        pass
