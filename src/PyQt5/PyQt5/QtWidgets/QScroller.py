...
class QScroller(__PyQt5_QtCore.QObject):
    ...
    def grabbedGesture(self, target): # real signature unknown; restored from __doc__
        """ grabbedGesture(target: QObject) -> Qt.GestureType """
        pass

    def grabGesture(self, target, scrollGestureType=None): # real signature unknown; restored from __doc__
        """ grabGesture(target: QObject, scrollGestureType: QScroller.ScrollerGestureType = QScroller.TouchGesture) -> Qt.GestureType """
        pass
    ...
    def hasScroller(self, target): # real signature unknown; restored from __doc__
        """ hasScroller(target: QObject) -> bool """
        return False
    ...
    def scroller(self, target): # real signature unknown; restored from __doc__
        """ scroller(target: QObject) -> QScroller """
        return QScroller
