...
class QSplashScreen(QWidget):
    ...
    QSplashScreen(parent: QWidget, pixmap: QPixmap = QPixmap(), flags: Union[Qt.WindowFlags, Qt.WindowType] = Qt.WindowFlags())
    QSplashScreen(screen: QScreen, pixmap: QPixmap = QPixmap(), flags: Union[Qt.WindowFlags, Qt.WindowType] = Qt.WindowFlags())
    """
    ...
    def drawContents(self, painter): # real signature unknown; restored from __doc__
        """ drawContents(self, painter: QPainter) """
        pass
    ...
    def showMessage(self, message, alignment=None, color, QColor=None, Qt_GlobalColor=None, QGradient=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ showMessage(self, message: str, alignment: int = Qt.AlignLeft, color: Union[QColor, Qt.GlobalColor, QGradient] = Qt.black) """
        pass
