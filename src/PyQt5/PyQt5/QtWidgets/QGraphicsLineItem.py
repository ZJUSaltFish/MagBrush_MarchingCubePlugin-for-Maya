...
class QGraphicsLineItem(QGraphicsItem):
    """
    QGraphicsLineItem(parent: typing.Optional[QGraphicsItem] = None)
    QGraphicsLineItem(line: QLineF, parent: typing.Optional[QGraphicsItem] = None)
    QGraphicsLineItem(x1: float, y1: float, x2: float, y2: float, parent: typing.Optional[QGraphicsItem] = None)
    """
    ...
    def setPen(self, pen, QPen=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
