...
class QLineEdit(QWidget):
    ...
    def insert(self, a0): # real signature unknown; restored from __doc__
        """ insert(self, a0: str) """
        pass
    ...
    def setPlaceholderText(self, a0): # real signature unknown; restored from __doc__
    ...
    def setValidator(self, a0): # real signature unknown; restored from __doc__
