...
class QTableWidgetItem(__sip.wrapper):
    ...
    QTableWidgetItem(text: str, type: int = QTableWidgetItem.ItemType.Type)
    QTableWidgetItem(icon: QIcon, text: str, type: int = QTableWidgetItem.ItemType.Type)
    ...
    def setBackground(self, brush, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
    ...
    def setForeground(self, brush, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
