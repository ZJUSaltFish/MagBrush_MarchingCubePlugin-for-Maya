...
class QStyle(__PyQt5_QtCore.QObject):
    ...
    def combinedLayoutSpacing(self, controls1, QSizePolicy_ControlTypes=None, QSizePolicy_ControlType=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ combinedLayoutSpacing(self, controls1: Union[QSizePolicy.ControlTypes, QSizePolicy.ControlType], controls2: Union[QSizePolicy.ControlTypes, QSizePolicy.ControlType], orientation: Qt.Orientation, option: typing.Optional[QStyleOption] = None, widget: typing.Optional[QWidget] = None) -> int """
        pass
    ...
    def drawItemText(self, painter, rectangle, alignment, palette, enabled, text, textRole=None): # real signature unknown; restored from __doc__
        """ drawItemText(self, painter: QPainter, rectangle: QRect, alignment: int, palette: QPalette, enabled: bool, text: str, textRole: QPalette.ColorRole = QPalette.NoRole) """
        pass
    ...
    def polish(self, a0): # real signature unknown; restored from __doc__ with multiple overloads
        """
        polish(self, a0: QWidget)
        polish(self, a0: QApplication)
    ...
    def standardPixmap(self, standardPixmap, option, QStyleOption=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ standardPixmap(self, standardPixmap: QStyle.StandardPixmap, option: typing.Optional[QStyleOption] = None, widget: typing.Optional[QWidget] = None) -> QPixmap """
        pass
    ...
    def styleHint(self, stylehint, option, QStyleOption=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ styleHint(self, stylehint: QStyle.StyleHint, option: typing.Optional[QStyleOption] = None, widget: typing.Optional[QWidget] = None, returnData: typing.Optional[QStyleHintReturn] = None) -> int """
        pass
    ...
    def subElementRect(self, subElement, option, widget, QWidget=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ subElementRect(self, subElement: QStyle.SubElement, option: QStyleOption, widget: typing.Optional[QWidget] = None) -> QRect """
        pass

    def timerEvent(self, *args, **kwargs): # real signature unknown
        pass

    def unpolish(self, a0): # real signature unknown; restored from __doc__ with multiple overloads
        """
        unpolish(self, a0: QWidget)
        unpolish(self, a0: QApplication)
        """
        pass
