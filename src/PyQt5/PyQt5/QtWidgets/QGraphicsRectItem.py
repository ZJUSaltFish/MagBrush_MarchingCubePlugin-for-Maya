...
class QGraphicsRectItem(QAbstractGraphicsShapeItem):
    """
    QGraphicsRectItem(parent: typing.Optional[QGraphicsItem] = None)
    QGraphicsRectItem(rect: QRectF, parent: typing.Optional[QGraphicsItem] = None)
    QGraphicsRectItem(x: float, y: float, w: float, h: float, parent: typing.Optional[QGraphicsItem] = None)
    """
