...
class QGraphicsItem(__sip.wrapper):
    """ QGraphicsItem(parent: typing.Optional[QGraphicsItem] = None) """
    ...
    def mapFromItem(self, item, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        mapFromItem(self, item: QGraphicsItem, point: Union[QPointF, QPoint]) -> QPointF
    ...
    def mapRectFromItem(self, item, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def mapRectToItem(self, item, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def mapToItem(self, item, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        mapToItem(self, item: QGraphicsItem, point: Union[QPointF, QPoint]) -> QPointF
