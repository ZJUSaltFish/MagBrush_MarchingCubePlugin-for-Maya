...
class QUndoView(QListView):
    """
    QUndoView(parent: typing.Optional[QWidget] = None)
    QUndoView(stack: QUndoStack, parent: typing.Optional[QWidget] = None)
    QUndoView(group: QUndoGroup, parent: typing.Optional[QWidget] = None)
    """
    ...
    def setEmptyLabel(self, label): # real signature unknown; restored from __doc__
        """ setEmptyLabel(self, label: str) """
        pass

    def setGroup(self, group): # real signature unknown; restored from __doc__
        """ setGroup(self, group: QUndoGroup) """
        pass
    ...
    def setStack(self, stack): # real signature unknown; restored from __doc__
        """ setStack(self, stack: QUndoStack) """
        pass
