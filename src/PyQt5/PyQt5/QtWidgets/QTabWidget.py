...
class QTabWidget(QWidget):
    """ QTabWidget(parent: typing.Optional[QWidget] = None) """
    def actionEvent(self, *args, **kwargs): # real signature unknown
        pass

    def addTab(self, widget, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def insertTab(self, index, widget, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def setTabBar(self, a0): # real signature unknown; restored from __doc__
    ...
    def setTabText(self, index, a1): # real signature unknown; restored from __doc__
