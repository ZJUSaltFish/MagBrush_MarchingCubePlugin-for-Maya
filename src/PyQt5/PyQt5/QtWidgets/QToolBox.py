...
class QToolBox(QFrame):
    """ QToolBox(parent: typing.Optional[QWidget] = None, flags: Union[Qt.WindowFlags, Qt.WindowType] = Qt.WindowFlags()) """
    def actionEvent(self, *args, **kwargs): # real signature unknown
        pass

    def addItem(self, item, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        addItem(self, item: QWidget, text: str) -> int
        addItem(self, item: QWidget, iconSet: QIcon, text: str) -> int
        """
        return 0
    ...
    def insertItem(self, index, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        insertItem(self, index: int, item: QWidget, text: str) -> int
        insertItem(self, index: int, widget: QWidget, icon: QIcon, text: str) -> int
        """
        return 0
    ...
    def setItemToolTip(self, index, toolTip): # real signature unknown; restored from __doc__
        """ setItemToolTip(self, index: int, toolTip: str) """
        pass
