...
class QButtonGroup(__PyQt5_QtCore.QObject):
    """ QButtonGroup(parent: typing.Optional[QObject] = None) """
    def addButton(self, a0, id=-1): # real signature unknown; restored from __doc__
        """ addButton(self, a0: QAbstractButton, id: int = -1) """
        pass
    ...
    def id(self, button): # real signature unknown; restored from __doc__
    ...
    def removeButton(self, a0): # real signature unknown; restored from __doc__
        """ removeButton(self, a0: QAbstractButton) """
        pass
    ...
    def setId(self, button, id): # real signature unknown; restored from __doc__
