...
class QTextEdit(QAbstractScrollArea):
    """
    QTextEdit(parent: typing.Optional[QWidget] = None)
    QTextEdit(text: str, parent: typing.Optional[QWidget] = None)
    """
    ...
    def find(self, exp, options, QTextDocument_FindFlags=None, QTextDocument_FindFlag=None, *args, **kwargs): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def setFontFamily(self, fontFamily): # real signature unknown; restored from __doc__
        """ setFontFamily(self, fontFamily: str) """
        pass
    ...
    def setTextBackgroundColor(self, c, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setTextBackgroundColor(self, c: Union[QColor, Qt.GlobalColor, QGradient]) """
        pass

    def setTextColor(self, c, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setTextColor(self, c: Union[QColor, Qt.GlobalColor, QGradient]) """
        pass
