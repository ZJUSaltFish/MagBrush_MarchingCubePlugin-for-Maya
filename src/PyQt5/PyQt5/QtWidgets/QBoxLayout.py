...
class QBoxLayout(QLayout):
    """ QBoxLayout(direction: QBoxLayout.Direction, parent: typing.Optional[QWidget] = None) """
    ...
    def addWidget(self, a0, stretch=0, alignment, Qt_Alignment=None, Qt_AlignmentFlag=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    ...
    def insertItem(self, index, a1): # real signature unknown; restored from __doc__
    ...
    def insertWidget(self, index, widget, stretch=0, alignment, Qt_Alignment=None, Qt_AlignmentFlag=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ insertWidget(self, index: int, widget: QWidget, stretch: int = 0, alignment: Union[Qt.Alignment, Qt.AlignmentFlag] = Qt.Alignment()) """
        pass
