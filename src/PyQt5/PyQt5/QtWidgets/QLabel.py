...
class QLabel(QFrame):
    """
    QLabel(parent: typing.Optional[QWidget] = None, flags: Union[Qt.WindowFlags, Qt.WindowType] = Qt.WindowFlags())
    QLabel(text: str, parent: typing.Optional[QWidget] = None, flags: Union[Qt.WindowFlags, Qt.WindowType] = Qt.WindowFlags())
    """
    ...
    def contextMenuEvent(self, ev): # real signature unknown; restored from __doc__
    ...
    def focusInEvent(self, ev): # real signature unknown; restored from __doc__
    ...
    def focusOutEvent(self, ev): # real signature unknown; restored from __doc__
    ...
    def setBuddy(self, a0): # real signature unknown; restored from __doc__
    ...
    def setMovie(self, movie): # real signature unknown; restored from __doc__
