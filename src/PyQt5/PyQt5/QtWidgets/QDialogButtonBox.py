...
class QDialogButtonBox(QWidget):
    """
    QDialogButtonBox(parent: typing.Optional[QWidget] = None)
    QDialogButtonBox(orientation: Qt.Orientation, parent: typing.Optional[QWidget] = None)
    QDialogButtonBox(buttons: Union[QDialogButtonBox.StandardButtons, QDialogButtonBox.StandardButton], parent: typing.Optional[QWidget] = None)
    QDialogButtonBox(buttons: Union[QDialogButtonBox.StandardButtons, QDialogButtonBox.StandardButton], orientation: Qt.Orientation, parent: typing.Optional[QWidget] = None)
    """
    ...
    def addButton(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        addButton(self, button: QAbstractButton, role: QDialogButtonBox.ButtonRole)
        addButton(self, text: str, role: QDialogButtonBox.ButtonRole) -> QPushButton
        addButton(self, button: QDialogButtonBox.StandardButton) -> QPushButton
        """
        return QPushButton

    def button(self, which): # real signature unknown; restored from __doc__
        """ button(self, which: QDialogButtonBox.StandardButton) -> QPushButton """
        return QPushButton

    def buttonRole(self, button): # real signature unknown; restored from __doc__
        """ buttonRole(self, button: QAbstractButton) -> QDialogButtonBox.ButtonRole """
        pass
    ...
    def standardButton(self, button): # real signature unknown; restored from __doc__
        """ standardButton(self, button: QAbstractButton) -> QDialogButtonBox.StandardButton """
        pass
