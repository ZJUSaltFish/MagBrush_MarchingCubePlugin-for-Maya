...
class QCalendarWidget(QWidget):
    """ QCalendarWidget(parent: typing.Optional[QWidget] = None) """
    ...
    def paintCell(self, painter, rect, date, QDate=None, datetime_date=None): # real signature unknown; restored from __doc__
        """ paintCell(self, painter: QPainter, rect: QRect, date: Union[QDate, datetime.date]) """
        pass
