...
class QCommandLinkButton(QPushButton):
    """
    QCommandLinkButton(parent: typing.Optional[QWidget] = None)
    QCommandLinkButton(text: str, parent: typing.Optional[QWidget] = None)
    QCommandLinkButton(text: str, description: str, parent: typing.Optional[QWidget] = None)
    """
