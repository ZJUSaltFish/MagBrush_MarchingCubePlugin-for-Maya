...
class QFontDialog(QDialog):
    """
    QFontDialog(parent: typing.Optional[QWidget] = None)
    QFontDialog(initial: QFont, parent: typing.Optional[QWidget] = None)
    """
    ...
    def getFont(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        getFont(initial: QFont, parent: typing.Optional[QWidget] = None, caption: str = '', options: Union[QFontDialog.FontDialogOptions, QFontDialog.FontDialogOption] = QFontDialog.FontDialogOptions()) -> Tuple[QFont, bool]
        getFont(parent: typing.Optional[QWidget] = None) -> Tuple[QFont, bool]
        """
        pass
