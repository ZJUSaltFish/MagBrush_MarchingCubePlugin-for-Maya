...
class QAction(__PyQt5_QtCore.QObject):
    """
    QAction(parent: typing.Optional[QObject] = None)
    QAction(text: str, parent: typing.Optional[QObject] = None)
    QAction(icon: QIcon, text: str, parent: typing.Optional[QObject] = None)
    """
    ...
    def setShortcut(self, shortcut, QKeySequence=None, QKeySequence_StandardKey=None, p_str=None, p_int=None): # real signature unknown; restored from __doc__
    ...
    def showStatusText(self, widget, QWidget=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ showStatusText(self, widget: typing.Optional[QWidget] = None) -> bool """
        pass
