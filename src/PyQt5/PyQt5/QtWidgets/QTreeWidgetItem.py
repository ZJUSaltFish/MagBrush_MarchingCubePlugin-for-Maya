...
class QTreeWidgetItem(__sip.wrapper):
    ...
    QTreeWidgetItem(parent: QTreeWidget, strings: Iterable[str], type: int = QTreeWidgetItem.Type)
    ...
    QTreeWidgetItem(parent: QTreeWidgetItem, strings: Iterable[str], type: int = QTreeWidgetItem.Type)
    ...
    def indexOfChild(self, achild): # real signature unknown; restored from __doc__
    ...
    def setBackground(self, column, brush, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setBackground(self, column: int, brush: Union[QBrush, QColor, Qt.GlobalColor, QGradient]) """
        pass
    ...
    def setForeground(self, column, brush, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setForeground(self, column: int, brush: Union[QBrush, QColor, Qt.GlobalColor, QGradient]) """
        pass
    ...
    def setStatusTip(self, column, astatusTip): # real signature unknown; restored from __doc__
        """ setStatusTip(self, column: int, astatusTip: str) """
        pass

    def setText(self, column, atext): # real signature unknown; restored from __doc__
    ...
    def setToolTip(self, column, atoolTip): # real signature unknown; restored from __doc__
        """ setToolTip(self, column: int, atoolTip: str) """
        pass

    def setWhatsThis(self, column, awhatsThis): # real signature unknown; restored from __doc__
        """ setWhatsThis(self, column: int, awhatsThis: str) """
        pass
