...
class QCompleter(__PyQt5_QtCore.QObject):
    """
    QCompleter(model: QAbstractItemModel, parent: typing.Optional[QObject] = None)
    QCompleter(list: Iterable[str], parent: typing.Optional[QObject] = None)
    QCompleter(parent: typing.Optional[QObject] = None)
    """
