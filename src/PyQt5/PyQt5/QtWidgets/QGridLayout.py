...
class QGridLayout(QLayout):
    ...
    def addItem(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        addItem(self, item: QLayoutItem, row: int, column: int, rowSpan: int = 1, columnSpan: int = 1, alignment: Union[Qt.Alignment, Qt.AlignmentFlag] = Qt.Alignment())
    ...
    def addLayout(self, a0, row, column, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        addLayout(self, a0: QLayout, row: int, column: int, alignment: Union[Qt.Alignment, Qt.AlignmentFlag] = Qt.Alignment())
        addLayout(self, a0: QLayout, row: int, column: int, rowSpan: int, columnSpan: int, alignment: Union[Qt.Alignment, Qt.AlignmentFlag] = Qt.Alignment())
        """
        pass
    ...
    def addWidget(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        addWidget(self, a0: QWidget, row: int, column: int, alignment: Union[Qt.Alignment, Qt.AlignmentFlag] = Qt.Alignment())
        addWidget(self, a0: QWidget, row: int, column: int, rowSpan: int, columnSpan: int, alignment: Union[Qt.Alignment, Qt.AlignmentFlag] = Qt.Alignment())
        """
        pass
