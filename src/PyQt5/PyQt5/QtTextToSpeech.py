...
# from D:\Maya2024\Python\lib\site-packages\PyQt5\QtTextToSpeech.pyd
# by generator 1.147
# no doc
...
class QTextToSpeech(__PyQt5_QtCore.QObject):
    """
    QTextToSpeech(parent: typing.Optional[QObject] = None)
    QTextToSpeech(engine: str, parent: typing.Optional[QObject] = None)
    """
    ...
    def say(self, text): # real signature unknown; restored from __doc__
        """ say(self, text: str) """
        pass
