...
class QSGImageNode(QSGGeometryNode):
    ...
    def rebuildGeometry(self, g, texture, rect, sourceRect, texCoordMode, QSGImageNode_TextureCoordinatesTransformMode=None, QSGImageNode_TextureCoordinatesTransformFlag=None): # real signature unknown; restored from __doc__
        """ rebuildGeometry(g: QSGGeometry, texture: QSGTexture, rect: QRectF, sourceRect: QRectF, texCoordMode: Union[QSGImageNode.TextureCoordinatesTransformMode, QSGImageNode.TextureCoordinatesTransformFlag]) """
        pass
    ...
    def setTexture(self, texture): # real signature unknown; restored from __doc__
        """ setTexture(self, texture: QSGTexture) """
        pass
