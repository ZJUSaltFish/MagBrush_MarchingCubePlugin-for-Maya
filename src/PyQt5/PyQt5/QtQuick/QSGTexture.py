...
class QSGTexture(__PyQt5_QtCore.QObject):
    ...
    def convertToNormalizedSourceRect(self, rect): # real signature unknown; restored from __doc__
        """ convertToNormalizedSourceRect(self, rect: QRectF) -> QRectF """
        pass
    ...
    def nativeTexture(self): # real signature unknown; restored from __doc__
        """ nativeTexture(self) -> QSGTexture.NativeTexture """
        pass
