...
class QSGRendererInterface(__sip.simplewrapper):
    # no doc
    def getResource(self, window, resource): # real signature unknown; restored from __doc__ with multiple overloads
        """
        getResource(self, window: QQuickWindow, resource: QSGRendererInterface.Resource) -> PyQt5.sip.voidptr
        getResource(self, window: QQuickWindow, resource: str) -> PyQt5.sip.voidptr
        """
        pass
