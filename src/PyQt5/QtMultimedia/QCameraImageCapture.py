...
class QCameraImageCapture(__PyQt5_QtCore.QObject, QMediaBindableInterface):
    """ QCameraImageCapture(mediaObject: QMediaObject, parent: typing.Optional[QObject] = None) """
    ...
    def setMediaObject(self, a0): # real signature unknown; restored from __doc__
        """ setMediaObject(self, a0: QMediaObject) -> bool """
        return False
