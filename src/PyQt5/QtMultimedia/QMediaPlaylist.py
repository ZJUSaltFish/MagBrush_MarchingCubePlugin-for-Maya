...
class QMediaPlaylist(__PyQt5_QtCore.QObject, QMediaBindableInterface):
    """ QMediaPlaylist(parent: typing.Optional[QObject] = None) """
    ...
    def load(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        load(self, request: QNetworkRequest, format: typing.Optional[str] = None)
        load(self, location: QUrl, format: typing.Optional[str] = None)
        load(self, device: QIODevice, format: typing.Optional[str] = None)
        """
        pass
    ...
    def save(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        save(self, location: QUrl, format: typing.Optional[str] = None) -> bool
        save(self, device: QIODevice, format: str) -> bool
        """
        return False
