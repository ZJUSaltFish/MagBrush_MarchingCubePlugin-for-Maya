...
class QMediaPlayer(QMediaObject):
    """ QMediaPlayer(parent: typing.Optional[QObject] = None, flags: Union[QMediaPlayer.Flags, QMediaPlayer.Flag] = QMediaPlayer.Flags()) """
    ...
    def bind(self, a0): # real signature unknown; restored from __doc__
        """ bind(self, a0: QObject) -> bool """
        return False
    ...
    def hasSupport(self, mimeType, codecs, p_str=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ hasSupport(mimeType: str, codecs: Iterable[str] = [], flags: Union[QMediaPlayer.Flags, QMediaPlayer.Flag] = QMediaPlayer.Flags()) -> QMultimedia.SupportEstimate """
        pass
    ...
    def setPlaylist(self, playlist): # real signature unknown; restored from __doc__
        """ setPlaylist(self, playlist: QMediaPlaylist) """
        pass
    ...
    def setVideoOutput(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setVideoOutput(self, a0: QVideoWidget)
        setVideoOutput(self, a0: QGraphicsVideoItem)
        setVideoOutput(self, surface: QAbstractVideoSurface)
    ...
    def unbind(self, a0): # real signature unknown; restored from __doc__
        """ unbind(self, a0: QObject) """
        pass
