...
class QMediaResource(__sip.simplewrapper):
    """
    QMediaResource()
    QMediaResource(url: QUrl, mimeType: str = '')
    QMediaResource(request: QNetworkRequest, mimeType: str = '')
    ...
    def setLanguage(self, language): # real signature unknown; restored from __doc__
