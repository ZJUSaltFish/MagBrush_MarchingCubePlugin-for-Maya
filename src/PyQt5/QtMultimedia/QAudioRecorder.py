...
class QAudioRecorder(QMediaRecorder):
    """ QAudioRecorder(parent: typing.Optional[QObject] = None) """
    ...
    def audioInputDescription(self, name): # real signature unknown; restored from __doc__
        """ audioInputDescription(self, name: str) -> str """
        return ""
    ...
    def setAudioInput(self, name): # real signature unknown; restored from __doc__
        """ setAudioInput(self, name: str) """
        pass
