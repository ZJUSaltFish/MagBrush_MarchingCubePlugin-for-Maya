...
class QCameraExposureControl(QMediaControl):
    """ QCameraExposureControl(parent: typing.Optional[QObject] = None) """
    ...
    def supportedParameterRange(self, parameter): # real signature unknown; restored from __doc__
        """ supportedParameterRange(self, parameter: QCameraExposureControl.ExposureParameter) -> Tuple[List[Any], bool] """
        pass
