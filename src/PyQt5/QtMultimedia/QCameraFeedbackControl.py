...
class QCameraFeedbackControl(QMediaControl):
    """ QCameraFeedbackControl(parent: typing.Optional[QObject] = None) """
    ...
    def setEventFeedbackSound(self, a0, filePath): # real signature unknown; restored from __doc__
        """ setEventFeedbackSound(self, a0: QCameraFeedbackControl.EventType, filePath: str) -> bool """
        return False
