...
class QMediaRecorder(__PyQt5_QtCore.QObject, QMediaBindableInterface):
    """ QMediaRecorder(mediaObject: QMediaObject, parent: typing.Optional[QObject] = None) """
    ...
    def setEncodingSettings(self, audio, video=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ setEncodingSettings(self, audio: QAudioEncoderSettings, video: QVideoEncoderSettings = QVideoEncoderSettings(), container: str = '') """
        pass
    ...
    def setMetaData(self, key, value): # real signature unknown; restored from __doc__
        """ setMetaData(self, key: str, value: Any) """
        pass
    ...
    def __init__(self, mediaObject, parent, QObject=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        pass
