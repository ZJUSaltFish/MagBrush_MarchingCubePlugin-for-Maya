...
class QQuickItem(__PyQt5_QtCore.QObject, __PyQt5_QtQml.QQmlParserStatus):
    ...
    def mapFromItem(self, item, point, QPointF=None, QPoint=None): # real signature unknown; restored from __doc__
        """ mapFromItem(self, item: QQuickItem, point: Union[QPointF, QPoint]) -> QPointF """
        pass
    ...
    def mapToItem(self, item, point, QPointF=None, QPoint=None): # real signature unknown; restored from __doc__
        """ mapToItem(self, item: QQuickItem, point: Union[QPointF, QPoint]) -> QPointF """
        pass
