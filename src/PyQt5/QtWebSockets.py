...
# from D:\Maya2024\Python\lib\site-packages\PyQt5\QtWebSockets.pyd
# by generator 1.147
# no doc
...
class QMaskGenerator(__PyQt5_QtCore.QObject):
    """ QMaskGenerator(parent: typing.Optional[QObject] = None) """
...
class QWebSocket(__PyQt5_QtCore.QObject):
    """ QWebSocket(origin: str = '', version: QWebSocketProtocol.Version = QWebSocketProtocol.VersionLatest, parent: typing.Optional[QObject] = None) """
    ...
    def setMaskGenerator(self, maskGenerator): # real signature unknown; restored from __doc__
        """ setMaskGenerator(self, maskGenerator: QMaskGenerator) """
        pass
    ...
    def __init__(self, origin='', version=None, parent, QObject=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        pass


class QWebSocketCorsAuthenticator(__sip.simplewrapper):
    """
    QWebSocketCorsAuthenticator(origin: str)
...
class QWebSocketServer(__PyQt5_QtCore.QObject):
    """ QWebSocketServer(serverName: str, secureMode: QWebSocketServer.SslMode, parent: typing.Optional[QObject] = None) """
    ...
    def handleConnection(self, socket): # real signature unknown; restored from __doc__
        """ handleConnection(self, socket: QTcpSocket) """
        pass
    ...
    def setServerName(self, serverName): # real signature unknown; restored from __doc__
        """ setServerName(self, serverName: str) """
        pass
    ...
    def __init__(self, serverName, secureMode, parent, QObject=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        pass
