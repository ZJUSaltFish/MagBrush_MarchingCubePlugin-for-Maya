# encoding: utf-8
# module PyQt5.QtNfc
# from D:\Maya2024\Python\lib\site-packages\PyQt5\QtNfc.pyd
# by generator 1.147
# no doc
...
class QNearFieldShareManager(__PyQt5_QtCore.QObject):
    """ QNearFieldShareManager(parent: typing.Optional[QObject] = None) """
    def childEvent(self, *args, **kwargs): # real signature unknown
        pass
...
class QQmlNdefRecord(__PyQt5_QtCore.QObject):
    """
    QQmlNdefRecord(parent: typing.Optional[QObject] = None)
    QQmlNdefRecord(record: QNdefRecord, parent: typing.Optional[QObject] = None)
    """
    def childEvent(self, *args, **kwargs): # real signature unknown
        pass
