...
class QSensor(__PyQt5_QtCore.QObject):
    """ QSensor(type: Union[QByteArray, bytes, bytearray], parent: typing.Optional[QObject] = None) """
    ...
    def addFilter(self, filter): # real signature unknown; restored from __doc__
        """ addFilter(self, filter: QSensorFilter) """
        pass
    ...
    def removeFilter(self, filter): # real signature unknown; restored from __doc__
        """ removeFilter(self, filter: QSensorFilter) """
        pass
