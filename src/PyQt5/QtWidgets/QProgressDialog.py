...
class QProgressDialog(QDialog):
    """
    QProgressDialog(parent: typing.Optional[QWidget] = None, flags: Union[Qt.WindowFlags, Qt.WindowType] = Qt.WindowFlags())
    QProgressDialog(labelText: str, cancelButtonText: str, minimum: int, maximum: int, parent: typing.Optional[QWidget] = None, flags: Union[Qt.WindowFlags, Qt.WindowType] = Qt.WindowFlags())
    """
    ...
    def setBar(self, bar): # real signature unknown; restored from __doc__
        """ setBar(self, bar: QProgressBar) """
        pass

    def setCancelButton(self, button): # real signature unknown; restored from __doc__
        """ setCancelButton(self, button: QPushButton) """
        pass

    def setCancelButtonText(self, a0): # real signature unknown; restored from __doc__
        """ setCancelButtonText(self, a0: str) """
        pass

    def setLabel(self, label): # real signature unknown; restored from __doc__
        """ setLabel(self, label: QLabel) """
        pass

    def setLabelText(self, a0): # real signature unknown; restored from __doc__
        """ setLabelText(self, a0: str) """
        pass
