...
class QWidget(__PyQt5_QtCore.QObject, __PyQt5_QtGui.QPaintDevice):
    ...
    def createWindowContainer(self, window, parent, QWidget=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    ...
    def grabShortcut(self, key, QKeySequence=None, QKeySequence_StandardKey=None, p_str=None, p_int=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    ...
    def isEnabledTo(self, a0): # real signature unknown; restored from __doc__
    ...
    def isVisibleTo(self, a0): # real signature unknown; restored from __doc__
    ...
    def mapFrom(self, a0, a1): # real signature unknown; restored from __doc__
    ...
    def mapTo(self, a0, a1): # real signature unknown; restored from __doc__
    ...
    def moveEvent(self, a0): # real signature unknown; restored from __doc__
    ...
    def setFocusProxy(self, a0): # real signature unknown; restored from __doc__
    ...
    def setLayout(self, a0): # real signature unknown; restored from __doc__
    ...
    def setParent(self, parent, f=None, Qt_WindowFlags=None, Qt_WindowType=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def setStatusTip(self, a0): # real signature unknown; restored from __doc__
    ...
    def setTabOrder(self, a0, a1): # real signature unknown; restored from __doc__
        """ setTabOrder(a0: QWidget, a1: QWidget) """
        pass

    def setToolTip(self, a0): # real signature unknown; restored from __doc__
    ...
    def setWhatsThis(self, a0): # real signature unknown; restored from __doc__
    ...
    def setWindowIconText(self, a0): # real signature unknown; restored from __doc__
    ...
    def setWindowRole(self, a0): # real signature unknown; restored from __doc__
    ...
    def setWindowTitle(self, a0): # real signature unknown; restored from __doc__
    ...
    def stackUnder(self, a0): # real signature unknown; restored from __doc__
