...
class QColorDialog(QDialog):
    """
    QColorDialog(parent: typing.Optional[QWidget] = None)
    QColorDialog(initial: Union[QColor, Qt.GlobalColor, QGradient], parent: typing.Optional[QWidget] = None)
    """
    ...
    def getColor(self, initial, QColor=None, Qt_GlobalColor=None, QGradient=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ getColor(initial: Union[QColor, Qt.GlobalColor, QGradient] = Qt.white, parent: typing.Optional[QWidget] = None, title: str = '', options: Union[QColorDialog.ColorDialogOptions, QColorDialog.ColorDialogOption] = QColorDialog.ColorDialogOptions()) -> QColor """
        pass
    ...
    def setCurrentColor(self, color, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setCurrentColor(self, color: Union[QColor, Qt.GlobalColor, QGradient]) """
        pass

    def setCustomColor(self, index, color, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setCustomColor(index: int, color: Union[QColor, Qt.GlobalColor, QGradient]) """
        pass
    ...
    def setStandardColor(self, index, color, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setStandardColor(index: int, color: Union[QColor, Qt.GlobalColor, QGradient]) """
        pass
