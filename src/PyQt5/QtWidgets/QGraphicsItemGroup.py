...
class QGraphicsItemGroup(QGraphicsItem):
    """ QGraphicsItemGroup(parent: typing.Optional[QGraphicsItem] = None) """
    def addToGroup(self, item): # real signature unknown; restored from __doc__
        """ addToGroup(self, item: QGraphicsItem) """
        pass
    ...
    def removeFromGroup(self, item): # real signature unknown; restored from __doc__
        """ removeFromGroup(self, item: QGraphicsItem) """
        pass
