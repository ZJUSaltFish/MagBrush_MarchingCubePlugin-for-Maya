...
class QGraphicsGridLayout(QGraphicsLayout):
    """ QGraphicsGridLayout(parent: typing.Optional[QGraphicsLayoutItem] = None) """
    def addChildLayoutItem(self, *args, **kwargs): # real signature unknown
        pass

    def addItem(self, item, row, column, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        addItem(self, item: QGraphicsLayoutItem, row: int, column: int, rowSpan: int, columnSpan: int, alignment: Union[Qt.Alignment, Qt.AlignmentFlag] = Qt.Alignment())
        addItem(self, item: QGraphicsLayoutItem, row: int, column: int, alignment: Union[Qt.Alignment, Qt.AlignmentFlag] = Qt.Alignment())
        """
        pass
    ...
    def itemAt(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        itemAt(self, row: int, column: int) -> QGraphicsLayoutItem
