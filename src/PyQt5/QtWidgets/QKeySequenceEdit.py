...
class QKeySequenceEdit(QWidget):
    """
    QKeySequenceEdit(parent: typing.Optional[QWidget] = None)
    QKeySequenceEdit(keySequence: Union[QKeySequence, QKeySequence.StandardKey, str, int], parent: typing.Optional[QWidget] = None)
    """
    ...
    def keySequenceChanged(self, *args, **kwargs): # real signature unknown
        """
        pyqtSignal(*types, name: str = ..., revision: int = ..., arguments: Sequence = ...) -> PYQT_SIGNAL
    ...
    def setKeySequence(self, keySequence, QKeySequence=None, QKeySequence_StandardKey=None, p_str=None, p_int=None): # real signature unknown; restored from __doc__
        """ setKeySequence(self, keySequence: Union[QKeySequence, QKeySequence.StandardKey, str, int]) """
        pass
