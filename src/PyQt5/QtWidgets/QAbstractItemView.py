...
class QAbstractItemView(QAbstractScrollArea):
    """ QAbstractItemView(parent: typing.Optional[QWidget] = None) """
    ...
    def edit(self, index, trigger=None, event=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
    ...
    def itemDelegate(self, index=None): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        itemDelegate(self, index: QModelIndex) -> QAbstractItemDelegate
        """
    ...
    def selectionCommand(self, index, event, QEvent=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ selectionCommand(self, index: QModelIndex, event: typing.Optional[QEvent] = None) -> QItemSelectionModel.SelectionFlags """
        pass
