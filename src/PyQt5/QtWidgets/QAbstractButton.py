...
class QAbstractButton(QWidget):
    """ QAbstractButton(parent: typing.Optional[QWidget] = None) """
    ...
    def setShortcut(self, key, QKeySequence=None, QKeySequence_StandardKey=None, p_str=None, p_int=None): # real signature unknown; restored from __doc__
