...
class QDirModel(__PyQt5_QtCore.QAbstractItemModel):
    """
    QDirModel(nameFilters: Iterable[str], filters: Union[QDir.Filters, QDir.Filter], sort: Union[QDir.SortFlags, QDir.SortFlag], parent: typing.Optional[QObject] = None)
    QDirModel(parent: typing.Optional[QObject] = None)
    """
    ...
    def index(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        index(self, path: str, column: int = 0) -> QModelIndex
        """
        pass
    ...
    def mkdir(self, parent, name): # real signature unknown; restored from __doc__
        """ mkdir(self, parent: QModelIndex, name: str) -> QModelIndex """
        pass
