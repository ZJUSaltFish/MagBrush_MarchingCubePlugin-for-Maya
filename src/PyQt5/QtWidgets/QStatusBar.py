...
class QStatusBar(QWidget):
    ...
    def insertPermanentWidget(self, index, widget, stretch=0): # real signature unknown; restored from __doc__
        """ insertPermanentWidget(self, index: int, widget: QWidget, stretch: int = 0) -> int """
        return 0

    def insertWidget(self, index, widget, stretch=0): # real signature unknown; restored from __doc__
        """ insertWidget(self, index: int, widget: QWidget, stretch: int = 0) -> int """
        return 0
    ...
    def showMessage(self, message, msecs=0): # real signature unknown; restored from __doc__
        """ showMessage(self, message: str, msecs: int = 0) """
        pass
