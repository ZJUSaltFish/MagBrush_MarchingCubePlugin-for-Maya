...
class QDial(QAbstractSlider):
    """ QDial(parent: typing.Optional[QWidget] = None) """
    ...
    def resizeEvent(self, re): # real signature unknown; restored from __doc__
        """ resizeEvent(self, re: QResizeEvent) """
        pass
