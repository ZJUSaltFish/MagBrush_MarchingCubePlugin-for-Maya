...
def qDrawBorderPixmap(painter, target, margins, pixmap): # real signature unknown; restored from __doc__
    """ qDrawBorderPixmap(painter: QPainter, target: QRect, margins: QMargins, pixmap: QPixmap) """
    pass

def qDrawPlainRect(p, x, y, w, h, a5, QColor=None, Qt_GlobalColor=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
def qDrawShadeLine(p, x1, y1, x2, y2, pal, sunken=True, lineWidth=1, midLineWidth=0): # real signature unknown; restored from __doc__
    """
...
def qDrawShadePanel(p, x, y, w, h, pal, sunken=False, lineWidth=1, fill, Union=None, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
def qDrawShadeRect(p, x, y, w, h, pal, sunken=False, lineWidth=1, midLineWidth=0, fill, Union=None, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
def qDrawWinButton(p, x, y, w, h, pal, sunken=False, fill, Union=None, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
...
def qDrawWinPanel(p, x, y, w, h, pal, sunken=False, fill, Union=None, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
    """
