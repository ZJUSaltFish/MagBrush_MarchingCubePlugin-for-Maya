...
class QTabBar(QWidget):
    """ QTabBar(parent: typing.Optional[QWidget] = None) """
    ...
    def addTab(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        addTab(self, icon: QIcon, text: str) -> int
        """
        return 0
    ...
    def initStyleOption(self, option, tabIndex): # real signature unknown; restored from __doc__
        """ initStyleOption(self, option: QStyleOptionTab, tabIndex: int) """
        pass
    ...
    def insertTab(self, index, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        insertTab(self, index: int, icon: QIcon, text: str) -> int
        """
        return 0
    ...
    def setAccessibleTabName(self, index, name): # real signature unknown; restored from __doc__
        """ setAccessibleTabName(self, index: int, name: str) """
        pass
    ...
    def setTabButton(self, index, position, widget): # real signature unknown; restored from __doc__
        """ setTabButton(self, index: int, position: QTabBar.ButtonPosition, widget: QWidget) """
        pass
    ...
    def setTabText(self, index, text): # real signature unknown; restored from __doc__
        """ setTabText(self, index: int, text: str) """
        pass

    def setTabTextColor(self, index, color, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setTabTextColor(self, index: int, color: Union[QColor, Qt.GlobalColor, QGradient]) """
        pass
    ...
    def tabButton(self, index, position): # real signature unknown; restored from __doc__
        """ tabButton(self, index: int, position: QTabBar.ButtonPosition) -> QWidget """
        return QWidget
