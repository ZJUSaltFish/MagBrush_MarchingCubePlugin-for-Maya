...
class QGraphicsColorizeEffect(QGraphicsEffect):
    """ QGraphicsColorizeEffect(parent: typing.Optional[QObject] = None) """
    ...
    def setColor(self, c, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
