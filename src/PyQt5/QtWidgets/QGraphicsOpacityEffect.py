...
class QGraphicsOpacityEffect(QGraphicsEffect):
    """ QGraphicsOpacityEffect(parent: typing.Optional[QObject] = None) """
    ...
    def setOpacityMask(self, mask, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setOpacityMask(self, mask: Union[QBrush, QColor, Qt.GlobalColor, QGradient]) """
        pass
