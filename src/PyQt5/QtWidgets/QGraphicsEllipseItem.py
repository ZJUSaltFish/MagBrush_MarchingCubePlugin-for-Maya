...
class QGraphicsEllipseItem(QAbstractGraphicsShapeItem):
    """
    QGraphicsEllipseItem(parent: typing.Optional[QGraphicsItem] = None)
    QGraphicsEllipseItem(rect: QRectF, parent: typing.Optional[QGraphicsItem] = None)
    QGraphicsEllipseItem(x: float, y: float, w: float, h: float, parent: typing.Optional[QGraphicsItem] = None)
    """
