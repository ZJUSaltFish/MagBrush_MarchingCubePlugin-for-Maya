...
class QDoubleSpinBox(QAbstractSpinBox):
    """ QDoubleSpinBox(parent: typing.Optional[QWidget] = None) """
    ...
    def setPrefix(self, p): # real signature unknown; restored from __doc__
    ...
    def setSuffix(self, s): # real signature unknown; restored from __doc__
