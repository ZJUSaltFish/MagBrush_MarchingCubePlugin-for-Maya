...
class QWizardPage(QWidget):
    """ QWizardPage(parent: typing.Optional[QWidget] = None) """
    ...
    def registerField(self, name, widget, property, p_str=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ registerField(self, name: str, widget: QWidget, property: typing.Optional[str] = None, changedSignal: PYQT_SIGNAL = 0) """
        pass
