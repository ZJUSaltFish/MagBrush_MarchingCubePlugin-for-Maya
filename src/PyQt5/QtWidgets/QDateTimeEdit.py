...
class QDateTimeEdit(QAbstractSpinBox):
    """
    QDateTimeEdit(parent: typing.Optional[QWidget] = None)
    QDateTimeEdit(datetime: Union[QDateTime, datetime.datetime], parent: typing.Optional[QWidget] = None)
    QDateTimeEdit(date: Union[QDate, datetime.date], parent: typing.Optional[QWidget] = None)
    QDateTimeEdit(time: Union[QTime, datetime.time], parent: typing.Optional[QWidget] = None)
    """
    ...
    def dateTimeFromText(self, text): # real signature unknown; restored from __doc__
        """ dateTimeFromText(self, text: str) -> QDateTime """
        pass
    ...
    def setCalendarWidget(self, calendarWidget): # real signature unknown; restored from __doc__
        """ setCalendarWidget(self, calendarWidget: QCalendarWidget) """
        pass
    ...
    def setDisplayFormat(self, format): # real signature unknown; restored from __doc__
        """ setDisplayFormat(self, format: str) """
        pass
