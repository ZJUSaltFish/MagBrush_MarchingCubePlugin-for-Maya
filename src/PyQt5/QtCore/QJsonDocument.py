...
class QJsonDocument(__sip.simplewrapper):
    """
    QJsonDocument()
    QJsonDocument(object: Dict[str, QJsonValue])
    QJsonDocument(array: Iterable[Union[QJsonValue, QJsonValue.Type, Dict[str, QJsonValue], bool, int, float, None, str]])
    ...
    def fromJson(self, json, QByteArray=None, bytes=None, bytearray=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ fromJson(json: Union[QByteArray, bytes, bytearray], error: typing.Optional[QJsonParseError] = None) -> QJsonDocument """
        pass

    def fromRawData(self, data, size, validation=None): # real signature unknown; restored from __doc__
        """ fromRawData(data: bytes, size: int, validation: QJsonDocument.DataValidation = QJsonDocument.Validate) -> QJsonDocument """
    ...
    def rawData(self): # real signature unknown; restored from __doc__
        """ rawData(self) -> Tuple[bytes, int] """
        pass

    def setArray(self, array, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ setArray(self, array: Iterable[Union[QJsonValue, QJsonValue.Type, Dict[str, QJsonValue], bool, int, float, None, str]]) """
        pass

    def setObject(self, p_object, p_str=None, QJsonValue=None): # real signature unknown; restored from __doc__
        """ setObject(self, object: Dict[str, QJsonValue]) """
        pass
