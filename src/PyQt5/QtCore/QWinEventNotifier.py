...
class QWinEventNotifier(QObject):
    """
    QWinEventNotifier(parent: typing.Optional[QObject] = None)
    QWinEventNotifier(hEvent: PyQt5.sip.voidptr, parent: typing.Optional[QObject] = None)
    """
    ...
    def setHandle(self, hEvent): # real signature unknown; restored from __doc__
        """ setHandle(self, hEvent: PyQt5.sip.voidptr) """
        pass
