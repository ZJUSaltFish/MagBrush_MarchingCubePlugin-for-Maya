...
class QSystemSemaphore(__sip.simplewrapper):
    """ QSystemSemaphore(key: str, initialValue: int = 0, mode: QSystemSemaphore.AccessMode = QSystemSemaphore.Open) """
    ...
    def setKey(self, key, initialValue=0, mode=None): # real signature unknown; restored from __doc__
        """ setKey(self, key: str, initialValue: int = 0, mode: QSystemSemaphore.AccessMode = QSystemSemaphore.Open) """
        pass
