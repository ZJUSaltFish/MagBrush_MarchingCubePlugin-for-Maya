...
class QMetaProperty(__sip.simplewrapper):
    ...
    def isDesignable(self, p_object, QObject=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ isDesignable(self, object: typing.Optional[QObject] = None) -> bool """
        pass
    ...
    def read(self, obj): # real signature unknown; restored from __doc__
        """ read(self, obj: QObject) -> Any """
        pass
    ...
    def reset(self, obj): # real signature unknown; restored from __doc__
        """ reset(self, obj: QObject) -> bool """
        return False
    ...
    def write(self, obj, value): # real signature unknown; restored from __doc__
        """ write(self, obj: QObject, value: Any) -> bool """
        return False
