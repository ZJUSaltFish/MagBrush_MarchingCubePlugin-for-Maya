...
class QUrl(__sip.simplewrapper):
    """
    QUrl()
    QUrl(url: str, mode: QUrl.ParsingMode = QUrl.TolerantMode)
    QUrl(copy: QUrl)
    """
    ...
    def fromLocalFile(self, localfile): # real signature unknown; restored from __doc__
        """ fromLocalFile(localfile: str) -> QUrl """
        return QUrl
    ...
    def fromStringList(self, uris, p_str=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ fromStringList(uris: Iterable[str], mode: QUrl.ParsingMode = QUrl.TolerantMode) -> List[QUrl] """
        pass

    def fromUserInput(self, userInput, workingDirectory=None, options=None, QUrl_UserInputResolutionOptions=None, QUrl_UserInputResolutionOption=None, *args=None, **kwargs=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        fromUserInput(userInput: str) -> QUrl
        fromUserInput(userInput: str, workingDirectory: str, options: Union[QUrl.UserInputResolutionOptions, QUrl.UserInputResolutionOption] = QUrl.DefaultResolution) -> QUrl
        """
        return QUrl
    ...
    def setAuthority(self, authority, mode=None): # real signature unknown; restored from __doc__
        """ setAuthority(self, authority: str, mode: QUrl.ParsingMode = QUrl.TolerantMode) """
        pass

    def setFragment(self, fragment, mode=None): # real signature unknown; restored from __doc__
        """ setFragment(self, fragment: str, mode: QUrl.ParsingMode = QUrl.TolerantMode) """
        pass

    def setHost(self, host, mode=None): # real signature unknown; restored from __doc__
        """ setHost(self, host: str, mode: QUrl.ParsingMode = QUrl.DecodedMode) """
        pass

    def setIdnWhitelist(self, a0, p_str=None): # real signature unknown; restored from __doc__
        """ setIdnWhitelist(a0: Iterable[str]) """
        pass

    def setPassword(self, password, mode=None): # real signature unknown; restored from __doc__
        """ setPassword(self, password: str, mode: QUrl.ParsingMode = QUrl.DecodedMode) """
        pass

    def setPath(self, path, mode=None): # real signature unknown; restored from __doc__
        """ setPath(self, path: str, mode: QUrl.ParsingMode = QUrl.DecodedMode) """
        pass
    ...
    def setQuery(self, query, mode=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setQuery(self, query: str, mode: QUrl.ParsingMode = QUrl.TolerantMode)
        setQuery(self, query: QUrlQuery)
        """
        pass

    def setScheme(self, scheme): # real signature unknown; restored from __doc__
        """ setScheme(self, scheme: str) """
        pass

    def setUrl(self, url, mode=None): # real signature unknown; restored from __doc__
        """ setUrl(self, url: str, mode: QUrl.ParsingMode = QUrl.TolerantMode) """
        pass

    def setUserInfo(self, userInfo, mode=None): # real signature unknown; restored from __doc__
        """ setUserInfo(self, userInfo: str, mode: QUrl.ParsingMode = QUrl.TolerantMode) """
        pass

    def setUserName(self, userName, mode=None): # real signature unknown; restored from __doc__
        """ setUserName(self, userName: str, mode: QUrl.ParsingMode = QUrl.DecodedMode) """
        pass
    ...
    def toAce(self, a0): # real signature unknown; restored from __doc__
        """ toAce(a0: str) -> QByteArray """
        return QByteArray
    ...
    def toPercentEncoding(self, input, exclude, QByteArray=None, bytes=None, bytearray=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ toPercentEncoding(input: str, exclude: Union[QByteArray, bytes, bytearray] = QByteArray(), include: Union[QByteArray, bytes, bytearray] = QByteArray()) -> QByteArray """
        pass
