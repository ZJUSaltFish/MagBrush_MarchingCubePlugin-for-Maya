...
class QXmlStreamReader(__sip.simplewrapper):
    ...
    QXmlStreamReader(data: str)
    """
    def addData(self, data, QByteArray=None, bytes=None, bytearray=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        addData(self, data: Union[QByteArray, bytes, bytearray])
        addData(self, data: str)
        """
        pass
    ...
    def setEntityResolver(self, resolver): # real signature unknown; restored from __doc__
        """ setEntityResolver(self, resolver: QXmlStreamEntityResolver) """
        pass
