...
class QDataStream(__sip.simplewrapper):
    """
    QDataStream()
    QDataStream(a0: QIODevice)
    QDataStream(a0: QByteArray, flags: Union[QIODevice.OpenMode, QIODevice.OpenModeFlag])
    ...
    def setDevice(self, a0): # real signature unknown; restored from __doc__
        """ setDevice(self, a0: QIODevice) """
        pass
    ...
    def writeBytes(self, a0, bytes=None): # real signature unknown; restored from __doc__
        """ writeBytes(self, a0: PyQt5.sip.array[bytes]) -> QDataStream """
        return QDataStream
    ...
    def writeQString(self, qstr): # real signature unknown; restored from __doc__
        """ writeQString(self, qstr: str) """
        pass

    def writeQStringList(self, qstrlst, p_str=None): # real signature unknown; restored from __doc__
        """ writeQStringList(self, qstrlst: Iterable[str]) """
        pass
    ...
    def writeQVariantHash(self, qvarhash, p_str=None, Any=None): # real signature unknown; restored from __doc__
        """ writeQVariantHash(self, qvarhash: Dict[str, Any]) """
        pass
    ...
    def writeRawData(self, a0, bytes=None): # real signature unknown; restored from __doc__
        """ writeRawData(self, a0: PyQt5.sip.array[bytes]) -> int """
        return 0

    def writeString(self, p_str): # real signature unknown; restored from __doc__
        """ writeString(self, str: bytes) """
        pass
    ...
    def __init__(self, a0=None, flags=None, QIODevice_OpenMode=None, QIODevice_OpenModeFlag=None): # real signature unknown; restored from __doc__ with multiple overloads
        pass
