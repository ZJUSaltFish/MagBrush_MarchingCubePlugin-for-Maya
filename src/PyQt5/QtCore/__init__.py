...
def qChecksum(s, bytes=None): # real signature unknown; restored from __doc__
    """
...
def qCritical(msg): # real signature unknown; restored from __doc__
    """ qCritical(msg: str) """
    pass

def qDebug(msg): # real signature unknown; restored from __doc__
    """ qDebug(msg: str) """
    pass

def qEnvironmentVariable(varName): # real signature unknown; restored from __doc__
    """
...
def qErrnoWarning(code, msg): # real signature unknown; restored from __doc__
    """
...
def qFatal(msg): # real signature unknown; restored from __doc__
    """ qFatal(msg: str) """
    pass
...
def qFormatLogMessage(type, context, buf): # real signature unknown; restored from __doc__
...
def qInfo(msg): # real signature unknown; restored from __doc__
    """ qInfo(msg: str) """
    pass
...
def qRegisterResourceData(a0, a1, a2, a3): # real signature unknown; restored from __doc__
...
def qSetMessagePattern(messagePattern): # real signature unknown; restored from __doc__
...
def qUnregisterResourceData(a0, a1, a2, a3): # real signature unknown; restored from __doc__
...
def qWarning(msg): # real signature unknown; restored from __doc__
    """ qWarning(msg: str) """
    pass
...
def Q_CLASSINFO(name, value): # real signature unknown; restored from __doc__
...
def Q_ENUMS(*a0): # real signature unknown; restored from __doc__
    """ Q_ENUMS(*a0) """
    pass
...
def Q_FLAGS(*a0): # real signature unknown; restored from __doc__
    """ Q_FLAGS(*a0) """
    pass
