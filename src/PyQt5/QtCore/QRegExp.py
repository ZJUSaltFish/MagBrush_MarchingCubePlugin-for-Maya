...
class QRegExp(__sip.simplewrapper):
    """
    QRegExp()
    QRegExp(pattern: str, cs: Qt.CaseSensitivity = Qt.CaseSensitive, syntax: QRegExp.PatternSyntax = QRegExp.RegExp)
    QRegExp(rx: QRegExp)
    """
    ...
    def indexIn(self, p_str, offset=0, caretMode=None): # real signature unknown; restored from __doc__
        """ indexIn(self, str: str, offset: int = 0, caretMode: QRegExp.CaretMode = QRegExp.CaretAtZero) -> int """
        return 0
    ...
    def lastIndexIn(self, p_str, offset=-1, caretMode=None): # real signature unknown; restored from __doc__
        """ lastIndexIn(self, str: str, offset: int = -1, caretMode: QRegExp.CaretMode = QRegExp.CaretAtZero) -> int """
        return 0
