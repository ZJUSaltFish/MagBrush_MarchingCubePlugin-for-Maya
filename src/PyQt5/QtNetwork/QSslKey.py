...
class QSslKey(__sip.simplewrapper):
    ...
    QSslKey(device: QIODevice, algorithm: QSsl.KeyAlgorithm, encoding: QSsl.EncodingFormat = QSsl.Pem, type: QSsl.KeyType = QSsl.PrivateKey, passPhrase: Union[QByteArray, bytes, bytearray] = QByteArray())
    QSslKey(handle: PyQt5.sip.voidptr, type: QSsl.KeyType = QSsl.PrivateKey)
