...
class QNetworkProxyQuery(__sip.simplewrapper):
    ...
    QNetworkProxyQuery(hostname: str, port: int, protocolTag: str = '', type: QNetworkProxyQuery.QueryType = QNetworkProxyQuery.TcpSocket)
    QNetworkProxyQuery(bindPort: int, protocolTag: str = '', type: QNetworkProxyQuery.QueryType = QNetworkProxyQuery.TcpServer)
    ...
    QNetworkProxyQuery(networkConfiguration: QNetworkConfiguration, hostname: str, port: int, protocolTag: str = '', type: QNetworkProxyQuery.QueryType = QNetworkProxyQuery.TcpSocket)
    QNetworkProxyQuery(networkConfiguration: QNetworkConfiguration, bindPort: int, protocolTag: str = '', type: QNetworkProxyQuery.QueryType = QNetworkProxyQuery.TcpServer)
    ...
    def setPeerHostName(self, hostname): # real signature unknown; restored from __doc__
        """ setPeerHostName(self, hostname: str) """
        pass
    ...
    def setProtocolTag(self, protocolTag): # real signature unknown; restored from __doc__
        """ setProtocolTag(self, protocolTag: str) """
        pass
