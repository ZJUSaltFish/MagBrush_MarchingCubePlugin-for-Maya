...
class QSslConfiguration(__sip.simplewrapper):
    ...
    def addCaCertificates(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        addCaCertificates(self, path: str, format: QSsl.EncodingFormat = QSsl.Pem, syntax: QSslCertificate.PatternSyntax = QSslCertificate.PatternSyntax.FixedString) -> bool
    ...
    def setBackendConfiguration(self, backendConfiguration, QByteArray=None, Any=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ setBackendConfiguration(self, backendConfiguration: Dict[QByteArray, Any] = {}) """
        pass
