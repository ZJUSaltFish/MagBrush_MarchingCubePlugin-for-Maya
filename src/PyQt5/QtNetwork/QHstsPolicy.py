...
class QHstsPolicy(__sip.simplewrapper):
    """
    QHstsPolicy()
    QHstsPolicy(expiry: Union[QDateTime, datetime.datetime], flags: Union[QHstsPolicy.PolicyFlags, QHstsPolicy.PolicyFlag], host: str, mode: QUrl.ParsingMode = QUrl.DecodedMode)
