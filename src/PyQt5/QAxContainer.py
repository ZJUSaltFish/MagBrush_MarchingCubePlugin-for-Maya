...
# from D:\Maya2024\Python\lib\site-packages\PyQt5\QAxContainer.pyd
# by generator 1.147
# no doc
...
class QAxWidget(__PyQt5_QtWidgets.QWidget, QAxBase):
    """
    QAxWidget(parent: typing.Optional[QWidget] = None, flags: Union[Qt.WindowFlags, Qt.WindowType] = 0)
    QAxWidget(a0: str, parent: typing.Optional[QWidget] = None, flags: Union[Qt.WindowFlags, Qt.WindowType] = 0)
    """
