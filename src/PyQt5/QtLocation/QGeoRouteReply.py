...
class QGeoRouteReply(__PyQt5_QtCore.QObject):
    """
    QGeoRouteReply(error: QGeoRouteReply.Error, errorString: str, parent: typing.Optional[QObject] = None)
    QGeoRouteReply(request: QGeoRouteRequest, parent: typing.Optional[QObject] = None)
    """
    ...
    def setError(self, error, errorString): # real signature unknown; restored from __doc__
        """ setError(self, error: QGeoRouteReply.Error, errorString: str) """
        pass
