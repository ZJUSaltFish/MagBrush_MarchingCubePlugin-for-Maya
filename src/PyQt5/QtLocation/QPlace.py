...
class QPlace(__sip.simplewrapper):
    ...
    def appendContactDetail(self, contactType, detail): # real signature unknown; restored from __doc__
        """ appendContactDetail(self, contactType: str, detail: QPlaceContactDetail) """
        pass
    ...
    def contactDetails(self, contactType): # real signature unknown; restored from __doc__
        """ contactDetails(self, contactType: str) -> List[QPlaceContactDetail] """
        return []
    ...
    def extendedAttribute(self, attributeType): # real signature unknown; restored from __doc__
        """ extendedAttribute(self, attributeType: str) -> QPlaceAttribute """
    ...
    def setContactDetails(self, contactType, details, QPlaceContactDetail=None): # real signature unknown; restored from __doc__
        """ setContactDetails(self, contactType: str, details: Iterable[QPlaceContactDetail]) """
        pass
    ...
    def setExtendedAttribute(self, attributeType, attribute): # real signature unknown; restored from __doc__
        """ setExtendedAttribute(self, attributeType: str, attribute: QPlaceAttribute) """
        pass
    ...
    def setPlaceId(self, identifier): # real signature unknown; restored from __doc__
        """ setPlaceId(self, identifier: str) """
        pass
