...
class QGeoServiceProvider(__PyQt5_QtCore.QObject):
    """ QGeoServiceProvider(providerName: str, parameters: Dict[str, Any] = {}, allowExperimental: bool = False) """
    ...
    def __init__(self, providerName, parameters, p_str=None, Any=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        pass
