...
# from D:\Maya2024\Python\lib\site-packages\PyQt5\QtRemoteObjects.pyd
# by generator 1.147
# no doc
...
class QRemoteObjectAbstractPersistedStore(__PyQt5_QtCore.QObject):
    ...
    def restoreProperties(self, repName, repSig, QByteArray=None, bytes=None, bytearray=None): # real signature unknown; restored from __doc__
        """ restoreProperties(self, repName: str, repSig: Union[QByteArray, bytes, bytearray]) -> List[Any] """
        return []

    def saveProperties(self, repName, repSig, QByteArray=None, bytes=None, bytearray=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ saveProperties(self, repName: str, repSig: Union[QByteArray, bytes, bytearray], values: Iterable[Any]) """
        pass
