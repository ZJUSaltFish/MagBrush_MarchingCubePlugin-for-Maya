...
class QPixmap(QPaintDevice):
    ...
    QPixmap(w: int, h: int)
    QPixmap(a0: QSize)
    QPixmap(fileName: str, format: typing.Optional[str] = None, flags: Union[Qt.ImageConversionFlags, Qt.ImageConversionFlag] = Qt.ImageConversionFlag.AutoColor)
    ...
    def createMaskFromColor(self, maskColor, QColor=None, Qt_GlobalColor=None, QGradient=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ createMaskFromColor(self, maskColor: Union[QColor, Qt.GlobalColor, QGradient], mode: Qt.MaskMode = Qt.MaskInColor) -> QBitmap """
        pass
    ...
    def fromImageReader(self, imageReader, flags, Qt_ImageConversionFlags=None, Qt_ImageConversionFlag=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ fromImageReader(imageReader: QImageReader, flags: Union[Qt.ImageConversionFlags, Qt.ImageConversionFlag] = Qt.AutoColor) -> QPixmap """
        pass
    ...
    def load(self, fileName, format, p_str=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ load(self, fileName: str, format: typing.Optional[str] = None, flags: Union[Qt.ImageConversionFlags, Qt.ImageConversionFlag] = Qt.AutoColor) -> bool """
        pass

    def loadFromData(self, buf, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        loadFromData(self, buf: PyQt5.sip.array[bytes], format: typing.Optional[str] = None, flags: Union[Qt.ImageConversionFlags, Qt.ImageConversionFlag] = Qt.AutoColor) -> bool
        loadFromData(self, buf: Union[QByteArray, bytes, bytearray], format: typing.Optional[str] = None, flags: Union[Qt.ImageConversionFlags, Qt.ImageConversionFlag] = Qt.AutoColor) -> bool
        """
        pass
    ...
    def save(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        save(self, fileName: str, format: typing.Optional[str] = None, quality: int = -1) -> bool
        save(self, device: QIODevice, format: typing.Optional[str] = None, quality: int = -1) -> bool
        """
        pass
    ...
    def scroll(self, dx, dy, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        scroll(self, dx: int, dy: int, rect: QRect) -> QRegion
        scroll(self, dx: int, dy: int, x: int, y: int, width: int, height: int) -> QRegion
        """
        return QRegion
