...
class QTextLayout(__sip.simplewrapper):
    """
    QTextLayout()
    QTextLayout(text: str)
    QTextLayout(text: str, font: QFont, paintDevice: typing.Optional[QPaintDevice] = None)
    ...
    def draw(self, p, pos, QPointF=None, QPoint=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ draw(self, p: QPainter, pos: Union[QPointF, QPoint], selections: Iterable[QTextLayout.FormatRange] = [], clip: QRectF = QRectF()) """
        pass

    def drawCursor(self, p, pos, QPointF=None, QPoint=None, *args, **kwargs): # real signature unknown; restored from __doc__ with multiple overloads
        """
        drawCursor(self, p: QPainter, pos: Union[QPointF, QPoint], cursorPosition: int)
        drawCursor(self, p: QPainter, pos: Union[QPointF, QPoint], cursorPosition: int, width: int)
        """
        pass
