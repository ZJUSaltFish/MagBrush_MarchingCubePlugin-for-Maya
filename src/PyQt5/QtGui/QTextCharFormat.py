...
class QTextCharFormat(QTextFormat):
    ...
    def setAnchorNames(self, names, p_str=None): # real signature unknown; restored from __doc__
        """ setAnchorNames(self, names: Iterable[str]) """
        pass
    ...
    def setFontFamilies(self, families, p_str=None): # real signature unknown; restored from __doc__
        """ setFontFamilies(self, families: Iterable[str]) """
        pass
    ...
    def setTextOutline(self, pen, QPen=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setTextOutline(self, pen: Union[QPen, QColor, Qt.GlobalColor, QGradient]) """
        pass
    ...
    def setUnderlineColor(self, color, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setUnderlineColor(self, color: Union[QColor, Qt.GlobalColor, QGradient]) """
        pass
