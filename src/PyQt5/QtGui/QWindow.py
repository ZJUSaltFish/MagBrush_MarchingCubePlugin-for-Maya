...
class QWindow(__PyQt5_QtCore.QObject, QSurface):
    """
    QWindow(screen: typing.Optional[QScreen] = None)
    ...
    def fromWinId(self, id): # real signature unknown; restored from __doc__
        """ fromWinId(id: PyQt5.sip.voidptr) -> QWindow """
        return QWindow
    ...
    def isAncestorOf(self, child, mode=None): # real signature unknown; restored from __doc__
        """ isAncestorOf(self, child: QWindow, mode: QWindow.AncestorMode = QWindow.IncludeTransients) -> bool """
        return False
    ...
    def parent(self, mode=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        parent(self) -> QWindow
        parent(self, mode: QWindow.AncestorMode) -> QWindow
        """
        return QWindow
    ...
    def setTransientParent(self, parent): # real signature unknown; restored from __doc__
        """ setTransientParent(self, parent: QWindow) """
        pass
    ...
    def touchEvent(self, a0): # real signature unknown; restored from __doc__
        """ touchEvent(self, a0: QTouchEvent) """
        pass
