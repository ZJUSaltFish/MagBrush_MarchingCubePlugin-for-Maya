...
class QOffscreenSurface(__PyQt5_QtCore.QObject, QSurface):
    """
    QOffscreenSurface(screen: typing.Optional[QScreen] = None)
    QOffscreenSurface(screen: QScreen, parent: QObject)
    """
    ...
    def nativeHandle(self): # real signature unknown; restored from __doc__
        """ nativeHandle(self) -> PyQt5.sip.voidptr """
        pass
    ...
    def setNativeHandle(self, handle): # real signature unknown; restored from __doc__
        """ setNativeHandle(self, handle: PyQt5.sip.voidptr) """
        pass
    ...
    def __init__(self, screen, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        pass
