...
class QBitmap(QPixmap):
    ...
    QBitmap(w: int, h: int)
    QBitmap(a0: QSize)
    QBitmap(fileName: str, format: typing.Optional[str] = None)
    QBitmap(variant: Any)
    """
    ...
    def fromData(self, size, bits, format=None): # real signature unknown; restored from __doc__
        """ fromData(size: QSize, bits: bytes, format: QImage.Format = QImage.Format_MonoLSB) -> QBitmap """
        return QBitmap
