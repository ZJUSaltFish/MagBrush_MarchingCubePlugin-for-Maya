...
class QOpenGLWindow(QPaintDeviceWindow):
    """
    QOpenGLWindow(updateBehavior: QOpenGLWindow.UpdateBehavior = QOpenGLWindow.NoPartialUpdate, parent: typing.Optional[QWindow] = None)
    QOpenGLWindow(shareContext: QOpenGLContext, updateBehavior: QOpenGLWindow.UpdateBehavior = QOpenGLWindow.NoPartialUpdate, parent: typing.Optional[QWindow] = None)
    """
