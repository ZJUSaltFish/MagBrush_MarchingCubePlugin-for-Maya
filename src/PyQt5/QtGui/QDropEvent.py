...
class QDropEvent(__PyQt5_QtCore.QEvent):
    """
    QDropEvent(pos: Union[QPointF, QPoint], actions: Union[Qt.DropActions, Qt.DropAction], data: QMimeData, buttons: Union[Qt.MouseButtons, Qt.MouseButton], modifiers: Union[Qt.KeyboardModifiers, Qt.KeyboardModifier], type: QEvent.Type = QEvent.Drop)
