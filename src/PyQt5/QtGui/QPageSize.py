...
class QPageSize(__sip.simplewrapper):
    ...
    QPageSize(pointSize: QSize, name: str = '', matchPolicy: QPageSize.SizeMatchPolicy = QPageSize.FuzzyMatch)
    QPageSize(size: QSizeF, units: QPageSize.Unit, name: str = '', matchPolicy: QPageSize.SizeMatchPolicy = QPageSize.FuzzyMatch)
