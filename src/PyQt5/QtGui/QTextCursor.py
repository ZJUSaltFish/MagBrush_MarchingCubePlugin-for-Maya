...
class QTextCursor(__sip.simplewrapper):
    ...
    def createList(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        createList(self, format: QTextListFormat) -> QTextList
        createList(self, style: QTextListFormat.Style) -> QTextList
        """
        return QTextList
    ...
    def insertFrame(self, format): # real signature unknown; restored from __doc__
        """ insertFrame(self, format: QTextFrameFormat) -> QTextFrame """
        return QTextFrame
    ...
    def insertImage(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        insertImage(self, image: QImage, name: str = '')
        """
        pass

    def insertList(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        insertList(self, format: QTextListFormat) -> QTextList
        insertList(self, style: QTextListFormat.Style) -> QTextList
        """
        return QTextList

    def insertTable(self, rows, cols, format=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        insertTable(self, rows: int, cols: int, format: QTextTableFormat) -> QTextTable
        insertTable(self, rows: int, cols: int) -> QTextTable
        """
        return QTextTable

    def insertText(self, text, format=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        insertText(self, text: str)
        insertText(self, text: str, format: QTextCharFormat)
        """
        pass
