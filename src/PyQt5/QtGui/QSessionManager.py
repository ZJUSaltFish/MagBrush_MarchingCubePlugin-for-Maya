...
class QSessionManager(__PyQt5_QtCore.QObject):
    ...
    def setDiscardCommand(self, a0, p_str=None): # real signature unknown; restored from __doc__
        """ setDiscardCommand(self, a0: Iterable[str]) """
        pass

    def setManagerProperty(self, name, value, p_str=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setManagerProperty(self, name: str, value: str)
        setManagerProperty(self, name: str, value: Iterable[str])
        """
        pass

    def setRestartCommand(self, a0, p_str=None): # real signature unknown; restored from __doc__
        """ setRestartCommand(self, a0: Iterable[str]) """
        pass
