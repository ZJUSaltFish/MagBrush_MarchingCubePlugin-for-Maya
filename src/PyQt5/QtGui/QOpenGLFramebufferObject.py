...
class QOpenGLFramebufferObject(__sip.simplewrapper):
    ...
    def blitFramebuffer(self, target, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        blitFramebuffer(target: QOpenGLFramebufferObject, targetRect: QRect, source: QOpenGLFramebufferObject, sourceRect: QRect, buffers: int = GL_COLOR_BUFFER_BIT, filter: int = GL_NEAREST)
        blitFramebuffer(target: QOpenGLFramebufferObject, source: QOpenGLFramebufferObject, buffers: int = GL_COLOR_BUFFER_BIT, filter: int = GL_NEAREST)
        blitFramebuffer(target: QOpenGLFramebufferObject, targetRect: QRect, source: QOpenGLFramebufferObject, sourceRect: QRect, buffers: int, filter: int, readColorAttachmentIndex: int, drawColorAttachmentIndex: int)
        blitFramebuffer(target: QOpenGLFramebufferObject, targetRect: QRect, source: QOpenGLFramebufferObject, sourceRect: QRect, buffers: int, filter: int, readColorAttachmentIndex: int, drawColorAttachmentIndex: int, restorePolicy: QOpenGLFramebufferObject.FramebufferRestorePolicy)
        """
        pass
