...
class QPen(__sip.simplewrapper):
    ...
    QPen()
    QPen(a0: Qt.PenStyle)
    QPen(brush: Union[QBrush, QColor, Qt.GlobalColor, QGradient], width: float, style: Qt.PenStyle = Qt.SolidLine, cap: Qt.PenCapStyle = Qt.SquareCap, join: Qt.PenJoinStyle = Qt.BevelJoin)
    QPen(pen: Union[QPen, QColor, Qt.GlobalColor, QGradient])
    QPen(variant: Any)
    """
    ...
    def setBrush(self, brush, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
    ...
    def setColor(self, color, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
