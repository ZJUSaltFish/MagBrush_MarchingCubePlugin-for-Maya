...
class QStandardItem(__sip.wrapper):
    ...
    QStandardItem(icon: QIcon, text: str)
    ...
    def child(self, row, column=0): # real signature unknown; restored from __doc__
        """ child(self, row: int, column: int = 0) -> QStandardItem """
    ...
    def setAccessibleDescription(self, aaccessibleDescription): # real signature unknown; restored from __doc__
        """ setAccessibleDescription(self, aaccessibleDescription: str) """
        pass

    def setAccessibleText(self, aaccessibleText): # real signature unknown; restored from __doc__
        """ setAccessibleText(self, aaccessibleText: str) """
        pass
    ...
    def setBackground(self, abrush, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setBackground(self, abrush: Union[QBrush, QColor, Qt.GlobalColor, QGradient]) """
        pass
    ...
    def setChild(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        setChild(self, row: int, column: int, item: QStandardItem)
        setChild(self, arow: int, aitem: QStandardItem)
        """
        pass
    ...
    def setForeground(self, abrush, QBrush=None, QColor=None, Qt_GlobalColor=None, QGradient=None): # real signature unknown; restored from __doc__
        """ setForeground(self, abrush: Union[QBrush, QColor, Qt.GlobalColor, QGradient]) """
        pass
    ...
    def takeChild(self, row, column=0): # real signature unknown; restored from __doc__
        """ takeChild(self, row: int, column: int = 0) -> QStandardItem """
        return QStandardItem
