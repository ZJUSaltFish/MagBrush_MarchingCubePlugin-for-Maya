...
class QOpenGLBuffer(__sip.simplewrapper):
    ...
    def allocate(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        allocate(self, data: PyQt5.sip.voidptr, count: int)
    ...
    def map(self, access): # real signature unknown; restored from __doc__
        """ map(self, access: QOpenGLBuffer.Access) -> PyQt5.sip.voidptr """
        pass
    ...
    def mapRange(self, offset, count, access, QOpenGLBuffer_RangeAccessFlags=None, QOpenGLBuffer_RangeAccessFlag=None): # real signature unknown; restored from __doc__
        """ mapRange(self, offset: int, count: int, access: Union[QOpenGLBuffer.RangeAccessFlags, QOpenGLBuffer.RangeAccessFlag]) -> PyQt5.sip.voidptr """
        pass

    def read(self, offset, data, count): # real signature unknown; restored from __doc__
        """ read(self, offset: int, data: PyQt5.sip.voidptr, count: int) -> bool """
        return False
    ...
    def write(self, offset, data, count): # real signature unknown; restored from __doc__
        """ write(self, offset: int, data: PyQt5.sip.voidptr, count: int) """
        pass
