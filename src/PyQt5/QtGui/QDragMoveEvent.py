...
class QDragMoveEvent(QDropEvent):
    """
    QDragMoveEvent(pos: QPoint, actions: Union[Qt.DropActions, Qt.DropAction], data: QMimeData, buttons: Union[Qt.MouseButtons, Qt.MouseButton], modifiers: Union[Qt.KeyboardModifiers, Qt.KeyboardModifier], type: QEvent.Type = QEvent.DragMove)
