...
class QNativeGestureEvent(QInputEvent):
    ...
    QNativeGestureEvent(type: Qt.NativeGestureType, dev: QTouchDevice, localPos: Union[QPointF, QPoint], windowPos: Union[QPointF, QPoint], screenPos: Union[QPointF, QPoint], value: float, sequenceId: int, intArgument: int)
