...
class QOpenGLDebugMessage(__sip.simplewrapper):
    ...
    def createApplicationMessage(self, text, id=0, severity=None, type=None): # real signature unknown; restored from __doc__
        """ createApplicationMessage(text: str, id: int = 0, severity: QOpenGLDebugMessage.Severity = QOpenGLDebugMessage.NotificationSeverity, type: QOpenGLDebugMessage.Type = QOpenGLDebugMessage.OtherType) -> QOpenGLDebugMessage """
    ...
    def createThirdPartyMessage(self, text, id=0, severity=None, type=None): # real signature unknown; restored from __doc__
        """ createThirdPartyMessage(text: str, id: int = 0, severity: QOpenGLDebugMessage.Severity = QOpenGLDebugMessage.NotificationSeverity, type: QOpenGLDebugMessage.Type = QOpenGLDebugMessage.OtherType) -> QOpenGLDebugMessage """
        return QOpenGLDebugMessage
