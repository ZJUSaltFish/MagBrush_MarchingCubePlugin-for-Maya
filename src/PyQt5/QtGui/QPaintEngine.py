...
class QPaintEngine(__sip.simplewrapper):
    ...
    def drawPolygon(self, points, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        """
        drawPolygon(self, points: PyQt5.sip.array[Union[QPointF, QPoint]], mode: QPaintEngine.PolygonDrawMode)
        drawPolygon(self, points: PyQt5.sip.array[QPoint], mode: QPaintEngine.PolygonDrawMode)
        """
        pass
