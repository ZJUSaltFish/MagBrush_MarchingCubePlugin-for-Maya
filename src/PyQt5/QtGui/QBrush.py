...
class QBrush(__sip.simplewrapper):
    ...
    QBrush(color: Union[QColor, Qt.GlobalColor, QGradient], style: Qt.BrushStyle = Qt.SolidPattern)
    QBrush(color: Union[QColor, Qt.GlobalColor, QGradient], pixmap: QPixmap)
    QBrush(pixmap: QPixmap)
    QBrush(image: QImage)
    QBrush(brush: Union[QBrush, QColor, Qt.GlobalColor, QGradient])
    QBrush(variant: Any)
    """
